...
import { FixedAssetsService, type FixedAsset, type AssetCategory, type AssetLocation, type DepreciationMethod, type AssetStatus } from '@/lib/fixed-assets-service'
            ...
            <Dialog open={showDetailsDialog} onOpenChange={setShowDetailsDialog}>
                <DialogContent className="max-w-4xl">
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Comprehensive information about this fixed asset
                        </DialogDescription>
                    </DialogHeader>
                    {selectedAsset && (
                        <ScrollArea className="max-h-96">
                            <div className="space-y-6">
                                ...
                                <div>
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <p className="text-sm font-mono">{selectedAsset.purchase_cost.toLocaleString()}</p>
                                        </div>
                                        <div>
                                            <Label className="text-sm font-medium">Current Book Value</Label>
                                            <p className="text-sm font-mono">{selectedAsset.current_book_value.toLocaleString()}</p>
                                        </div>
                                        <div>
                                            <Label className="text-sm font-medium">Accumulated Depreciation</Label>
                                            <p className="text-sm font-mono">{selectedAsset.accumulated_depreciation.toLocaleString()}</p>
                                        </div>
                                        <div>
                                            <Label className="text-sm font-medium">Salvage Value</Label>
                                            <p className="text-sm font-mono">{selectedAsset.salvage_value.toLocaleString()}</p>
                                        </div>
                                        <div>
                                            <Label className="text-sm font-medium">Depreciation Method</Label>
                                            <Badge className={getDepreciationMethodColor(selectedAsset.depreciation_method)}>
                                ...
                                <div>
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <p className="text-sm">{format(new Date(selectedAsset.purchase_date), 'PP')}</p>
                                        </div>
                                        <div>
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm">{selectedAsset.purchase_invoice_no || 'Not specified'}</p>
                                        </div>
                                        <div>
                                ...
                                {(selectedAsset.serial_number || selectedAsset.model || selectedAsset.manufacturer) && (
                                    <div>
