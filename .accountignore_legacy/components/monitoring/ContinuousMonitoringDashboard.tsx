    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        ...
        <div className="flex gap-2">
          ...
          <Button onClick={executeMonitoringRules} disabled={processing} className="gap-2">
            ...
            <div className="flex items-center justify-between">
              <div>
                <strong className="text-red-800 dark:text-red-200">
                  {dashboardData.monitoring_summary.critical_alerts} Critical Alert
                  {dashboardData.monitoring_summary.critical_alerts > 1 ? "s" : ""}
                </strong>
                  ...
                  {dashboardData.recent_alerts.slice(0, 5).map((alert, index) => (
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2">
                        <Badge
                          className={getAlertSeverityColor(alert.alert_severity)}
                          variant="outline"
                        >
                  ...
                  {dashboardData.recent_exceptions.slice(0, 5).map((exception, index) => (
                    ...
                    >
                      <div className="flex-1">
                        ...
                        <div className="text-xs text-muted-foreground">
                          {formatDate(exception.exception_date)} • {exception.severity_level}{" "}
                          severity
                        </div>
                      </div>
                      <div className="flex items-center gap-2">
                        <Badge
                          className={getStatusColor(exception.exception_status)}
                          variant="outline"
                        >
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <Badge variant="secondary">{alert.alert_category}</Badge>
                      ...
                      <div className="grid grid-cols-3 gap-4 text-sm">
                        {alert.trigger_value && (
                          <div>
                            ...
                            <span className="font-medium">
                              {alert.trigger_value.toLocaleString()}
                            </span>
                          </div>
                        )}
              ...
              <CardContent className="p-4">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <div className="text-2xl font-bold">{dashboardData.kri_summary.total_kris}</div>
                  </div>
                ...
                <CardContent className="p-4">
                  <div className="flex items-start justify-between mb-4">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <Badge
                        className={`${
                          kri.status_color === "Red"
                            ? "bg-red-50 text-red-600 border-red-200"
                            : kri.status_color === "Yellow"
                  ...
                  <div className="space-y-3">
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <span
                          className={`font-medium flex items-center gap-1 ${
                            kri.variance_percentage > 0 ? "text-red-600" : "text-green-600"
                          }`}
                        >
                          {kri.variance_percentage > 0 ? (
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <Badge
                        variant="outline"
                        className={
                          kri.risk_level === "Critical"
                            ? "text-red-600 border-red-200"
                            : kri.risk_level === "High"
                              ? "text-orange-600 border-orange-200"
                              : kri.risk_level === "Medium"
      ...
      <Dialog open={showAnalysisDialog} onOpenChange={setShowAnalysisDialog}>
        <DialogContent className="max-w-6xl max-h-[80vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle>Monitoring Analysis Report</DialogTitle>
            <DialogDescription>
                        ...
                        <div key={index} className="flex justify-between items-center text-sm">
                          ...
                          <div className="flex gap-4">
                            ...
                            <span className="text-green-600">
                              {formatPercentage(pattern.resolution_rate)} resolved
                            </span>
                          </div>
                        </div>
                      ))}
