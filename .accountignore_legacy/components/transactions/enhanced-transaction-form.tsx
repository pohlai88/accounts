            ...
            <CardContent>
                <Tabs value={activeTab} onValueChange={setActiveTab}>
                    ...
                    <TabsContent value="sales_invoice" className="space-y-4">
                        <div className="grid grid-cols-2 gap-4">
                            <div className="space-y-2">
                                ...
                                <Input
                                    ...
                                    onChange={(e) => setSalesInvoiceForm({ ...salesInvoiceForm, customer_name: e.target.value })}
                            ...
                            <div className="space-y-2">
                                ...
                                <Input
                                    ...
                                    onChange={(e) => setSalesInvoiceForm({ ...salesInvoiceForm, invoice_amount: e.target.value })}
                                    placeholder="0.00"
                                />
                            </div>
                            ...
                            <div className="space-y-2">
                                ...
                                <Select
                                    ...
                                    onValueChange={(value) => setSalesInvoiceForm({ ...salesInvoiceForm, receivable_account_id: value })}
                                >
                                    <SelectTrigger>
                            ...
                            <div className="space-y-2">
                                ...
                                <Select
                                    ...
                                    onValueChange={(value) => setSalesInvoiceForm({ ...salesInvoiceForm, revenue_account_id: value })}
                                >
                                    <SelectTrigger>
                            ...
                            <div className="space-y-2">
                                ...
                                <Input
                                    ...
                                    onChange={(e) => setSalesInvoiceForm({ ...salesInvoiceForm, posting_date: e.target.value })}
                                />
                            </div>
                            ...
                            <div className="space-y-2">
                                ...
                                <Input
                                    ...
                                    onChange={(e) => setSalesInvoiceForm({ ...salesInvoiceForm, due_date: e.target.value })}
                                />
                            </div>
                        </div>
                        ...
                        <div className="space-y-2">
                            ...
                            <Textarea
                                ...
                                onChange={(e) => setSalesInvoiceForm({ ...salesInvoiceForm, remarks: e.target.value })}
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div className="space-y-2">
                                ...
                                <Select
                                    ...
                                    onValueChange={(value) => setPaymentForm({ ...paymentForm, receivable_account_id: value })}
                                >
                                    <SelectTrigger>
                                        <SelectValue placeholder="Select receivable account" />
                                    </SelectTrigger>
                            ...
                            <div className="space-y-2">
                                ...
                                <Input
                                    ...
                                    onChange={(e) => setPaymentForm({ ...paymentForm, against_invoice: e.target.value })}
                    ...
                    <TabsContent value="reversal" className="space-y-4">
                        ...
                        <Button onClick={handleReversal} disabled={loading} className="w-full" variant="destructive">
                    ...
                    <div className={`mt-6 p-4 rounded-lg border ${result.success ? 'bg-green-50 border-green-200' : 'bg-red-50 border-red-200'}`}>
                        ...
                        {result.success && result.data && (
                            <div className="text-sm text-green-700 space-y-1">
                                <div>Voucher: {result.data.voucher_type} {result.data.voucher_no}</div>
                                {result.data.amount && <div>Amount: ${result.data.amount}</div>}
                                {result.data.customer && <div>Customer: {result.data.customer}</div>}
                                {result.data.gl_entries && <div>GL Entries Created: {result.data.gl_entries.length}</div>}
                            </div>
                        )}
