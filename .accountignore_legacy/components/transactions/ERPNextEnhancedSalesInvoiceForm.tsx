...
import DocumentWorkflowStatus, { DocumentStatus } from '@/components/workflow/DocumentWorkflowStatus'
...
export function ERPNextEnhancedSalesInvoiceForm({
    ...
    const calculateTotals = () => {
        ...
        const discountAmount = watchedValues.discount_type === 'Percentage'
                    ...
                    <TabsContent value="dimensions" className="space-y-4">
                        ...
                        <CostCenterSelector
                            ...
                            onCostCenterChange={(costCenterId) =>
                                form.setValue('cost_center_id', costCenterId)
                            }
                        />
                                            ...
                                            <TableRow key={field.id}>
                                                ...
                                                <TableCell>
                                                    <span className="font-medium">
                                                        ${((watchedItems[index]?.qty || 0) * (watchedItems[index]?.rate || 0)).toFixed(2)}
                                                    </span>
                                                </TableCell>
                                                <TableCell>
                                                    <CostCenterSelector
