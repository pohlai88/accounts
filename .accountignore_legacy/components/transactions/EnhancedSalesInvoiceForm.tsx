...
export function EnhancedSalesInvoiceForm({
  ...
  const handleSubmitInvoice = async () => {
    ...
    try {
      ...
      // Submit the invoice
      const result = await DocumentWorkflowEngine.submitSalesInvoice(invoice.id, {
        userId: user.id,
      ...
      <Dialog open={showSubmitDialog} onOpenChange={setShowSubmitDialog}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Are you sure you want to submit this invoice? Once submitted, it cannot be edited and
              will create GL entries.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
      ...
      <Dialog open={showCancelDialog} onOpenChange={setShowCancelDialog}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Please provide a reason for cancelling this invoice. This action will create reverse
              GL entries.
            </DialogDescription>
          </DialogHeader>
