            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                ...
                <div className="flex justify-between items-center pt-6 border-t">
                    ...
                    <div className="flex space-x-2">
                        ...
                        <Button type="submit" disabled={isSubmitting || loading} className="bg-gradient-to-r from-blue-500 to-purple-500 hover:from-blue-600 hover:to-purple-600">
                            <Save className="h-4 w-4 mr-2" />
                            {isSubmitting || loading ? 'Saving...' : 'Save Invoice'}
                        </Button>
                        <Button type="button" className="bg-gradient-to-r from-green-500 to-blue-500 hover:from-green-600 hover:to-blue-600">
            ...
            <Dialog open={showCustomerDialog} onOpenChange={setShowCustomerDialog}>
                <DialogContent className="max-w-4xl">
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Choose a customer from your customer database
                        </DialogDescription>
                    </DialogHeader>
                    <div className="space-y-4">
                        <div className="relative">
