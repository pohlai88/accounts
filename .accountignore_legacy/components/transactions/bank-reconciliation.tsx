...
import { BankReconciliationService, BankAccount, BankStatement, BankStatementItem, PotentialMatch } from '@/lib/bank-reconciliation'
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <Select
                                            ...
                                            onValueChange={(value) => setAccountForm(prev => ({ ...prev, accountType: value as any }))}
                                        >
                                            <SelectTrigger>
                                                <SelectValue />
                                            </SelectTrigger>
                    ...
                    <CardContent>
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                            {bankAccounts.map((account) => (
                                <Card
                                    key={account.id}
                                    className={`cursor-pointer transition-colors ${selectedAccount?.id === account.id ? 'ring-2 ring-blue-500' : 'hover:bg-muted/50'
                                        }`}
                                            ...
                                            <TableBody>
                                                {statements.map((statement) => (
                                                    <TableRow key={statement.id}>
                                                        ...
                                                        <TableCell>
                                                            <Badge className={statement.isReconciled ? 'text-green-600 bg-green-50' : 'text-yellow-600 bg-yellow-50'}>
                                        ...
                                        <CardContent>
                                            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                                                <div className="text-center">
                                                    <div className="text-2xl font-bold">{reconciliationSummary.totalItems}</div>
                                                    <div className="text-sm text-muted-foreground">Total Items</div>
                                                </div>
                                                <div className="text-center">
                                                    <div className="text-2xl font-bold text-green-600">{reconciliationSummary.reconciledItems}</div>
                                                    <div className="text-sm text-muted-foreground">Reconciled</div>
                                                </div>
                                                <div className="text-center">
                                                    <div className="text-2xl font-bold text-red-600">{reconciliationSummary.unreconciledItems}</div>
                                                    <div className="text-sm text-muted-foreground">Unreconciled</div>
                                                </div>
                                                <div className="text-center">
                                                    <div className="text-2xl font-bold">{reconciliationSummary.reconciliationPercentage.toFixed(1)}%</div>
                                                    <div className="text-sm text-muted-foreground">Complete</div>
                                                </div>
                                            </div>
                                            <div className="mt-4">
                                                <Progress value={reconciliationSummary.reconciliationPercentage} className="h-2" />
                                            </div>
                                        </CardContent>
                                    </Card>
                                )}
                    ...
                    <div className="space-y-4">
                        <div>
                            ...
                            <Input
                                ...
                                onChange={(e) => setStatementForm(prev => ({ ...prev, statementDate: e.target.value }))}
                            />
                        </div>
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <Input
                                    ...
                                    onChange={(e) => setStatementForm(prev => ({ ...prev, openingBalance: parseFloat(e.target.value) }))}
                                />
                            </div>
                            <div>
                                ...
                                <Input
                                    ...
                                    onChange={(e) => setStatementForm(prev => ({ ...prev, closingBalance: parseFloat(e.target.value) }))}
                                />
                            </div>
                        </div>
                        <div className="flex justify-end space-x-2">
                            ...
                            <Button onClick={handleCreateStatement}>
                                Create Statement
                            </Button>
                        </div>
                    </div>
                                    ...
                                    <TableRow key={index}>
                                        <TableCell>
                                            <div className="flex items-center space-x-2">
                                                ...
                                                <span className="text-sm font-medium">{match.matchConfidence.toFixed(1)}%</span>
                                            </div>
                                        </TableCell>
                                        ...
                                        <TableCell>
                                            <Button
                                                size="sm"
                                                onClick={() => handleCreateMatch(match.glEntryId)}
                                            >
                                                Match
                                            </Button>
                                        </TableCell>
