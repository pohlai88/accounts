...
import { RecurringTransactionsService, RecurringTemplate, RecurringExecution, CreateRecurringTemplateInput } from '@/lib/recurring-transactions'
                                        ...
                                        <TableBody>
                                            {templates.map((template) => (
                                                <TableRow key={template.id}>
                                                    ...
                                                    <TableCell>
                                                        <Badge className={template.isActive ? 'text-green-600 bg-green-50' : 'text-gray-600 bg-gray-50'}>
