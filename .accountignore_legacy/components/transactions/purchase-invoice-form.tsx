...
import { Plus, Trash2, Save, X, FileText, Building2, Calendar, DollarSign } from "lucide-react";
import {
  TransactionService,
  CreateInvoiceInput,
    ...
    <div className="max-w-6xl mx-auto p-6 space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>Create a new purchase invoice from your supplier</CardDescription>
        </CardHeader>
        <CardContent>
