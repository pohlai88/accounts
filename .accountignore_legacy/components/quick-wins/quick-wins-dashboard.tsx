                            ...
                            <div className="space-y-4">
                                ...
                                <div className="space-y-2 max-h-64 overflow-y-auto">
                                    {mockItems.slice(0, 10).map((item) => (
                                        <div
                                            key={item.id}
                                            className={`flex items-center justify-between p-2 border rounded cursor-pointer ${selection.selectedItems.includes(item) ? 'bg-blue-50 border-blue-200' : ''
                                                }`}
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex items-center justify-between p-4 border rounded-lg">
                                    ...
                                    <div className="flex items-center space-x-2">
                                        ...
                                        {!autoSaveState.isDirty && !autoSaveState.isSaving && autoSaveState.lastSaved && (
                                            <CheckCircle className="h-4 w-4 text-green-500" />
                                        )}
                                        <span className="text-sm text-muted-foreground">
                                            {autoSaveState.isSaving && 'Saving...'}
                                            {autoSaveState.isDirty && !autoSaveState.isSaving && 'Unsaved changes'}
                                            {!autoSaveState.isDirty && !autoSaveState.isSaving && autoSaveState.lastSaved && 'Saved'}
                                        </span>
                                    </div>
                                </div>
                ...
                <TabsContent value="performance" className="space-y-4">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Configure performance settings for optimal speed
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                            <div className="space-y-4">
                                ...
                                <div className="space-y-4">
                                    ...
                                    {Object.entries(performanceOptimizations).map(([key, enabled]) => (
                                        <div key={key} className="flex items-center justify-between">
                                            ...
                                            <Switch
                                                checked={enabled}
                                                onCheckedChange={() => toggleOptimization(key as keyof typeof performanceOptimizations)}
                                            />
                                        </div>
                                    ))}
                                </div>
