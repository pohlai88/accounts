...
export function MobileLayout({
  ...
  const navigationItems = [
    ...
    },
    {
      ...
      href: "/tax-management",
      icon: Calculator,
      current: pathname.startsWith("/tax-management"),
    },
    {
      name: "Reports",
      href: "/reports",
      ...
      <header className="sticky top-0 z-50 bg-background border-b border-border">
        <div className="flex items-center justify-between px-4 py-3">
          ...
          <div className="flex items-center space-x-2">
            ...
            {/* Add button */}
            {showAddButton && (
              <Button size="sm" onClick={onAddClick} className="p-2">
...
export function MobileButton({
  ...
  return (
    <Button variant={variant} size={size} className={`w-full ${className}`} {...props}>
      {children}
    </Button>
  );
}
