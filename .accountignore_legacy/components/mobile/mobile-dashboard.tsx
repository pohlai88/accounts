...
export function MobileDashboard({ companyId, userId }: MobileDashboardProps) {
    ...
    const dashboardData = {
        ...
        overdueInvoices: 2,
        recentTransactions: [
            { id: '1', description: 'Payment from ABC Corp', amount: 5000, type: 'income', date: '2024-01-15' },
            { id: '2', description: 'Office supplies', amount: -250, type: 'expense', date: '2024-01-14' },
            { id: '3', description: 'Consulting services', amount: 3500, type: 'income', date: '2024-01-13' },
            { id: '4', description: 'Software subscription', amount: -99, type: 'expense', date: '2024-01-12' },
        ...
        >
            ...
            <div className="p-4">
                <div className="grid grid-cols-2 gap-3 mb-6">
                    ...
                    <MobileButton variant="outline" className="h-20 flex flex-col items-center justify-center space-y-2">
                        ...
                        <div className="flex items-start space-x-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-blue-700">
                                    Swipe left on transactions to edit, swipe right to delete.
                                    This works throughout the app!
                                </p>
                            </div>
                        </div>
                    </MobileCard>
