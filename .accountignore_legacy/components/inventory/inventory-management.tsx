...
import { InventoryManagementService, Item, Warehouse as WarehouseInterface, CreateItemInput, CreateWarehouseInput } from '@/lib/inventory-management'
...
export function InventoryManagement({ companyId }: InventoryManagementProps) {
    ...
    const getItemTypeColor = (itemType: string) => {
        switch (itemType) {
            ...
            case 'Consumable': return 'text-orange-600 bg-orange-50'
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <Select
                                            ...
                                            onValueChange={(value) => setItemForm(prev => ({ ...prev, unitOfMeasure: value }))}
                                        >
                                            <SelectTrigger>
                                                <SelectValue />
                                            </SelectTrigger>
                                    ...
                                    <div>
                                        ...
                                        <Select
                                            ...
                                            onValueChange={(value) => setItemForm(prev => ({ ...prev, itemType: value as any }))}
                                        >
                                            <SelectTrigger>
                                                <SelectValue />
                                            </SelectTrigger>
                                ...
                                <Dialog open={showCreateWarehouseDialog} onOpenChange={setShowCreateWarehouseDialog}>
                                    ...
                                    <DialogContent>
                                        ...
                                        <div className="space-y-4">
                                            <div className="grid grid-cols-2 gap-4">
                                                <div>
                                                    ...
                                                    <Input
                                                        ...
                                                        onChange={(e) => setWarehouseForm(prev => ({ ...prev, warehouseCode: e.target.value }))}
                                                ...
                                                <div>
                                                    ...
                                                    <Input
                                                        ...
                                                        onChange={(e) => setWarehouseForm(prev => ({ ...prev, warehouseName: e.target.value }))}
                                            ...
                                            <div className="flex justify-end space-x-2">
                                                <Button variant="outline" onClick={() => setShowCreateWarehouseDialog(false)}>
                                                    Cancel
                                                </Button>
