...
export default function AssetForm({ assetId, onSave, onCancel }: AssetFormProps) {
    ...
    if (selectedCategory && formData.asset_category_id === selectedCategory.id) {
      setFormData(prev => ({
        ...
        total_number_of_depreciations:
          prev.total_number_of_depreciations || selectedCategory.total_number_of_depreciations,
        frequency_of_depreciation:
          prev.frequency_of_depreciation || selectedCategory.frequency_of_depreciation,
      }));
    }
  ...
  const validateForm = (): boolean => {
    ...
    if (formData.calculate_depreciation) {
      if (!formData.total_number_of_depreciations || formData.total_number_of_depreciations <= 0) {
        newErrors.total_number_of_depreciations =
          "Total number of depreciations must be greater than 0";
      }
  ...
  const calculateDepreciationAmount = () => {
    ...
    const depreciableAmount =
      formData.gross_purchase_amount - (formData.expected_value_after_useful_life || 0);
        ...
        <div>
          ...
          <p className="text-muted-foreground">
            {assetId
              ...
              : "Add a new fixed asset to your inventory"}
          </p>
        </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  <Label htmlFor="asset_category_id" className="required">
                    Asset Category
                  </Label>
                  <Select
                    value={formData.asset_category_id}
                    onValueChange={value => handleFieldChange("asset_category_id", value)}
                  >
                ...
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={value => handleFieldChange("asset_owner", value as AssetOwner)}
                  >
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
                ...
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={value =>
                      handleFieldChange("asset_condition", value as AssetCondition)
                    }
                  >
                    <SelectTrigger>
                      <SelectValue />
        ...
        <TabsContent value="financial" className="space-y-6">
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <Label htmlFor="gross_purchase_amount" className="required">
                  ...
                  <Input
                    ...
                    onChange={e =>
                      handleFieldChange("gross_purchase_amount", parseFloat(e.target.value) || 0)
                    }
                    placeholder="0.00"
                    step="0.01"
                    min="0"
                ...
                <div>
                  <Label htmlFor="purchase_date" className="required">
                    Purchase Date
                  </Label>
                  <Input
                    id="purchase_date"
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={e =>
                      handleFieldChange("purchase_receipt_amount", parseFloat(e.target.value) || 0)
                    }
                    placeholder="0.00"
                    step="0.01"
                    min="0"
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <Select
                        ...
                        onValueChange={value =>
                          handleFieldChange("depreciation_method", value as DepreciationMethod)
                        }
                      >
                        <SelectTrigger>
                        ...
                        <SelectContent>
                          ...
                          <SelectItem value="Double Declining Balance">
                    ...
                    <div>
                      <Label htmlFor="total_number_of_depreciations">
                    ...
                    <div>
                      <Label htmlFor="frequency_of_depreciation">
                        Frequency of Depreciation (per year)
                      </Label>
                      <Select
                        value={formData.frequency_of_depreciation?.toString() || ""}
                        onValueChange={value =>
                          handleFieldChange("frequency_of_depreciation", parseInt(value))
                        }
                      >
                        <SelectTrigger
                          className={errors.frequency_of_depreciation ? "border-red-500" : ""}
                        >
                    ...
                    <div>
                      <Label htmlFor="expected_value_after_useful_life">
                  ...
                  {formData.is_existing_asset && (
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-4 bg-muted/50 rounded-lg">
                      <div>
                        <Label htmlFor="opening_accumulated_depreciation">
                      ...
                      <div>
                        <Label htmlFor="number_of_depreciations_booked">
                    ...
                    <div className="grid grid-cols-2 gap-4 text-sm">
                      <div>
                        ...
                        <span className="font-medium ml-2">
                          $
                          {(
                            (formData.gross_purchase_amount || 0) -
                            (formData.expected_value_after_useful_life || 0)
                          ).toLocaleString()}
                        </span>
                      </div>
                      <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={e =>
                      handleFieldChange("insured_value", parseFloat(e.target.value) || 0)
                    }
                    placeholder="0.00"
                    step="0.01"
                    min="0"
