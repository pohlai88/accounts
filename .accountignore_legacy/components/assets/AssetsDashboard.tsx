...
import { FixedAssetsService, Asset, AssetCategory, AssetLocation } from '@/lib/fixed-assets-service'
            ...
            {analytics && (
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <div className="text-2xl font-bold">{formatCurrency(analytics.total_asset_value)}</div>
                            <p className="text-xs text-muted-foreground">
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <div className="text-2xl font-bold text-amber-600">{analytics.maintenance_due_soon}</div>
                            <p className="text-xs text-muted-foreground">
                                Next 30 days
                            </p>
                        </CardContent>
                            ...
                            <tbody>
                                {assets.map((asset) => (
                                    <tr key={asset.id} className="border-b hover:bg-muted/50">
                                        ...
                                        <td className="p-3">
                                            <div className="text-sm">{(asset as any).category?.category_name || 'N/A'}</div>
                                        </td>
                                        <td className="p-3">
                                        ...
                                        <td className="p-3">
                                            <div className="font-medium">{formatCurrency(asset.gross_purchase_amount)}</div>
                                        </td>
                                        <td className="p-3">
