                                                ...
                                                <tr key={doc.id} className="border-b hover:bg-muted/50">
                                                    ...
                                                    <td className="p-3">
                                                        <div className="flex gap-1">
                                                            {doc.can_view && <Badge variant="secondary" className="text-xs">View</Badge>}
                                                            {doc.can_download && <Badge variant="secondary" className="text-xs">Download</Badge>}
                                                            {doc.can_print && <Badge variant="secondary" className="text-xs">Print</Badge>}
                                                        </div>
                                                    </td>
                                                    <td className="p-3">
                                                ...
                                                <div className="flex items-center justify-between mb-2">
                                                    ...
                                                    <div className="flex items-center gap-2">
                                                        ...
                                                        {message.priority !== 'Normal' && (
                                                            <Badge variant={message.priority === 'High' || message.priority === 'Urgent' ? 'destructive' : 'secondary'} className="text-xs">
                                                                {message.priority}
                                                            </Badge>
                                                        )}
                                                    </div>
                                            ...
                                            <tbody>
                                                {payments.map((payment) => (
                                                    <tr key={payment.id} className="border-b hover:bg-muted/50">
                                                        ...
                                                        <td className="p-3">
                                                            <div className="font-medium">{formatCurrency(payment.payment_amount)}</div>
                                                        </td>
                                                        <td className="p-3">
                                                            <Badge variant="outline">
