...
export default function TreasuryOptimizationDashboard({ companyId }: TreasuryOptimizationDashboardProps) {
    ...
    const getComponentCategoryColor = (category: string) => {
        switch (category) {
            case 'Current Assets': return 'text-green-600 bg-green-50 border-green-200'
            case 'Current Liabilities': return 'text-red-600 bg-red-50 border-red-200'
            case 'Inventory': return 'text-blue-600 bg-blue-50 border-blue-200'
            case 'Receivables': return 'text-purple-600 bg-purple-50 border-purple-200'
            case 'Payables': return 'text-orange-600 bg-orange-50 border-orange-200'
    ...
    const getInvestmentTypeIcon = (type: string) => {
        switch (type) {
            case 'Money Market': return <PiggyBank className="w-4 h-4 text-blue-600" />
            case 'Treasury Bills': return <Building2 className="w-4 h-4 text-green-600" />
            case 'CDs': return <CreditCard className="w-4 h-4 text-purple-600" />
            case 'Commercial Paper': return <FileText className="w-4 h-4 text-orange-600" />
            case 'Corporate Bonds': return <Award className="w-4 h-4 text-pink-600" />
    ...
    return (
        <div className="space-y-6">
            ...
            {/* Risk Alerts Banner */}
            {(dashboardData.risk_alerts.high_risk_positions > 0 || dashboardData.risk_alerts.liquidity_warnings > 0) && (
                        ...
                        <div className="flex items-center justify-between">
                            <div>
                                <strong className="text-red-800 dark:text-red-200">
                                    Treasury Risk Alert: {dashboardData.risk_alerts.high_risk_positions} high-risk positions, {dashboardData.risk_alerts.liquidity_warnings} liquidity warnings
                                </strong>
                ...
                <Card>
                    ...
                    <CardContent>
                        ...
                        <p className="text-xs text-muted-foreground mt-1">
                            Ratio: {formatPercentage(dashboardData.working_capital_summary.working_capital_ratio * 100)}
                        </p>
                    </CardContent>
                </Card>
            ...
            <Card>
                ...
                <CardContent>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div className="space-y-3">
                                <div className="flex items-center justify-between">
                                    ...
                                    <div className="flex items-center gap-1">
                                        <span className="font-medium">{dashboardData.working_capital_summary.cash_conversion_cycle.toFixed(1)} days</span>
                                    </div>
                                </div>
                                <div className="flex items-center justify-between">
                                    <span className="text-sm">Liquidity Score</span>
                                    <div className="flex items-center gap-2">
                                        <Progress value={dashboardData.working_capital_summary.liquidity_score} className="w-16 h-2" />
                        ...
                        <div>
                            <div className="text-sm font-medium text-muted-foreground mb-2">Cash Flow Forecast</div>
                            <div className="space-y-3">
                                <div className="flex items-center justify-between">
                                    <span className="text-sm">7-Day Net Flow</span>
                                    <span className={`font-medium ${dashboardData.liquidity_summary.cash_flow_forecast_7d >= 0 ? 'text-green-600' : 'text-red-600'
                                        }`}>
                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    <div className="flex items-center gap-2">
                                        <Progress value={dashboardData.liquidity_summary.credit_utilization * 100} className="w-16 h-2" />
                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    <Badge variant={dashboardData.liquidity_summary.liquidity_risk_score > 50 ? 'destructive' : 'secondary'}>
                        ...
                        <div>
                            <div className="text-sm font-medium text-muted-foreground mb-2">Optimization Performance</div>
                            <div className="space-y-3">
                                <div className="flex items-center justify-between">
                                    <span className="text-sm">Strategy Performance</span>
                                    <div className="flex items-center gap-2">
                                        <Progress value={dashboardData.optimization_summary.average_strategy_performance} className="w-16 h-2" />
                                ...
                                <div className="space-y-4">
                                    {dashboardData.working_capital_components.slice(0, 5).map((component, index) => (
                                        <div key={index} className="flex items-center justify-between">
                                            <div className="flex items-center gap-2">
                                                <Badge className={getComponentCategoryColor(component.component_category)} variant="outline">
                                            ...
                                            <div className="flex items-center gap-2">
                                                <Progress
                                                    value={component.efficiency_score || 0}
                                                    className="w-16 h-2"
                                                />
                                    ...
                                    {dashboardData.urgent_recommendations.slice(0, 5).map((recommendation, index) => (
                                        <div key={index} className="flex items-start gap-3 p-3 border rounded-lg">
                                            ...
                                            <div className="flex-1 min-w-0">
                                                <div className="font-medium text-sm truncate">{recommendation.recommendation_title}</div>
                                                <div className="text-xs text-muted-foreground mt-1">
                                                    {recommendation.recommendation_type} • Priority: {recommendation.priority_score}
                                                </div>
                                            ...
                                            <div className="flex items-center gap-2">
                                                <Badge
                                                    variant="outline"
                                                    className={`text-xs ${recommendation.urgency_level === 'Critical' ? 'border-red-200 text-red-600' :
                                                            recommendation.urgency_level === 'High' ? 'border-orange-200 text-orange-600' :
                                                                recommendation.urgency_level === 'Medium' ? 'border-yellow-200 text-yellow-600' :
                                ...
                                <CardContent className="p-4">
                                    ...
                                    <div className="space-y-3">
                                        <div className="flex justify-between items-center">
                                            ...
                                            <span className="font-medium">{formatCurrency(component.current_balance)}</span>
                                        </div>
                                        ...
                                        {component.current_days_outstanding && (
                                            <div className="flex justify-between items-center">
                                                ...
                                                <span className="font-medium">{component.current_days_outstanding} days</span>
                                            </div>
                                        )}

                                        <div className="flex justify-between items-center">
                                            <span className="text-sm text-muted-foreground">Priority</span>
                                            <Badge variant={component.optimization_priority === 'High' ? 'destructive' : 'secondary'}>
                                ...
                                <CardContent className="p-4">
                                    <div className="flex items-start justify-between mb-3">
                                        <div className="flex-1">
                                            ...
                                            <Badge className={getStrategyStatusColor(strategy.strategy_status)} variant="outline">
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <div className="flex justify-between">
                                            ...
                                            <span className="text-sm font-medium">{formatCurrency(strategy.target_cash_balance)}</span>
                                        </div>
                                        <div className="flex justify-between">
                                        ...
                                        <div className="flex justify-between">
                                            ...
                                            <div className="flex items-center gap-2">
                                                <Progress value={strategy.current_performance_score || 0} className="w-12 h-2" />
                                                <span className="text-sm font-medium">
                            ...
                            <div className="border rounded-lg overflow-hidden">
                                ...
                                {dashboardData.current_liquidity_positions.slice(0, 10).map((position, index) => (
                                    <div key={index} className="grid grid-cols-8 gap-4 p-3 border-t text-sm hover:bg-muted/50">
                                        ...
                                        <div className="text-right">
                                            {position.days_cash_on_hand ? `${position.days_cash_on_hand.toFixed(1)} days` : 'N/A'}
                                        </div>
                                        <div className="text-right">
                                            {position.liquidity_risk_score ? (
                                                <Badge variant={position.liquidity_risk_score > 50 ? 'destructive' : 'secondary'}>
                                        ...
                                        <div>
                                            <Badge className={
                                                position.validation_status === 'validated' ? 'text-green-600 bg-green-50' :
                                                    position.validation_status === 'flagged' ? 'text-red-600 bg-red-50' :
                                ...
                                <CardContent className="p-4">
                                    <div className="flex items-start justify-between mb-3">
                                        ...
                                        <div className="text-right">
                                            {opportunity.ai_recommendation_score && (
                                                <Badge className="bg-blue-50 text-blue-600 border-blue-200" variant="outline">
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <div className="flex justify-between">
                                            ...
                                            <span className="text-sm font-medium">{opportunity.investment_term_days} days</span>
                                        </div>
                                        <div className="flex justify-between">
                                            <span className="text-sm text-muted-foreground">Min Investment:</span>
                                            <span className="text-sm font-medium">{formatCurrency(opportunity.minimum_investment)}</span>
                                        </div>
                                        <div className="flex justify-between">
                                            <span className="text-sm text-muted-foreground">Risk Category:</span>
                                            <Badge variant={
                                                opportunity.risk_category === 'Very Low' ? 'default' :
                                                    opportunity.risk_category === 'Low' ? 'secondary' :
                                                        opportunity.risk_category === 'Medium' ? 'outline' : 'destructive'
                                            }>
                                        ...
                                        {opportunity.liquidity_score && (
                                            <div className="flex justify-between">
                                                ...
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <span className="text-sm font-medium">{opportunity.liquidity_score.toFixed(0)}</span>
                                                </div>
                                            </div>
                                        )}
                                    </div>
            ...
            <Dialog open={showAnalysisDialog} onOpenChange={setShowAnalysisDialog}>
                <DialogContent className="max-w-6xl max-h-[80vh] overflow-y-auto">
                    <DialogHeader>
                        <DialogTitle>
                            Treasury Optimization Analysis Report
                        </DialogTitle>
                        <DialogDescription>
                            Comprehensive analysis of working capital, optimization strategies, and performance metrics
                        </DialogDescription>
                    </DialogHeader>
                        ...
                        <div className="space-y-6">
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                ...
                                <Card>
                                    ...
                                    <CardContent>
                                        <div className="space-y-2">
                                            {analysisData.optimization_performance.by_strategy_type.map((strategy, index) => (
                                                <div key={index} className="flex justify-between items-center text-sm">
                                                    <span>{strategy.strategy_type}</span>
                                                    <div className="flex gap-4">
                                                        <span>{strategy.execution_count} executions</span>
                                                        <span className="text-green-600">{formatPercentage(strategy.avg_return * 100)} return</span>
                                                        <span className="text-blue-600">{formatPercentage(strategy.success_rate)} success</span>
                                                    </div>
                                                </div>
                                            ))}
                                        </div>
