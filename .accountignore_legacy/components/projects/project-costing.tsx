    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Track project costs, time, and profitability</p>
        </div>
          ...
          <Dialog open={showCreateProjectDialog} onOpenChange={setShowCreateProjectDialog}>
            ...
            <DialogContent className="max-w-2xl">
              <DialogHeader>
                ...
                <DialogDescription>Set up a new project for cost tracking</DialogDescription>
              </DialogHeader>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input
                      ...
                      onChange={e =>
                        setProjectForm(prev => ({ ...prev, projectCode: e.target.value }))
                      }
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <Select
                      ...
                      onValueChange={value =>
                        setProjectForm(prev => ({ ...prev, projectType: value as any }))
                      }
                    >
                      <SelectTrigger>
                        <SelectValue />
                  ...
                  <div>
                    ...
                    <Select
                      ...
                      onValueChange={value =>
                        setProjectForm(prev => ({ ...prev, priority: value as any }))
                      }
                    >
                      <SelectTrigger>
                        <SelectValue />
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={e =>
                        setProjectForm(prev => ({
                          ...prev,
                          budgetAmount: parseFloat(e.target.value),
                        }))
                      }
                    />
                  </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Select a project to view detailed costing information</CardDescription>
        </CardHeader>
        <CardContent>
              ...
              <CardContent>
                {expenses.length > 0 ? (
                  ...
                  <div className="text-center py-8">
                    ...
                    <p className="text-muted-foreground mb-4">Track expenses for this project</p>
                    <Button onClick={() => setShowCreateExpenseDialog(true)}>
                      <Plus className="h-4 w-4 mr-2" />
                      Add Expense
                    </Button>
              ...
              <CardContent>
                {budgets.length > 0 ? (
                  ...
                  <div className="text-center py-8">
                    ...
                    <p className="text-muted-foreground">Set up budgets for this project</p>
                  </div>
                )}
              </CardContent>
            </Card>
      ...
      <Dialog open={showCreateTimeDialog} onOpenChange={setShowCreateTimeDialog}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>Log time spent on {selectedProject?.projectName}</DialogDescription>
          </DialogHeader>
          <div className="space-y-4">
            <div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <Input
                  ...
                  onChange={e =>
                    setTimeForm(prev => ({ ...prev, hoursWorked: parseFloat(e.target.value) }))
                  }
                />
              </div>
              <div>
                ...
                <Input
                  ...
                  onChange={e =>
                    setTimeForm(prev => ({ ...prev, hourlyRate: parseFloat(e.target.value) }))
                  }
                />
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <Select
                  ...
                  onValueChange={value =>
                    setExpenseForm(prev => ({ ...prev, category: value as any }))
                  }
                >
                  <SelectTrigger>
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={e =>
                    setExpenseForm(prev => ({ ...prev, amount: parseFloat(e.target.value) }))
                  }
                />
              </div>
            </div>
