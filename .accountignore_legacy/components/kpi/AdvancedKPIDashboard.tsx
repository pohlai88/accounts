...
export default function AdvancedKPIDashboard({ companyId, dashboardId }: AdvancedKPIDashboardProps) {
        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <Card>
                    ...
                    <CardContent>
                        ...
                        <div className="mt-2">
                            <Progress value={dashboardData.performance_overview.financial_health_score} className="h-2" />
                        </div>
                ...
                <Card>
                    ...
                    <CardContent>
                        ...
                        <div className="mt-2">
                            <Progress value={dashboardData.performance_overview.operational_efficiency_score} className="h-2" />
                        </div>
                        <p className="text-xs text-muted-foreground mt-2">
                ...
                <Card>
                    ...
                    <CardContent>
                        ...
                        <div className="mt-2">
                            <Progress value={dashboardData.performance_overview.growth_momentum_score} className="h-2" />
                        </div>
                        <p className="text-xs text-muted-foreground mt-2">
                ...
                <Card>
                    ...
                    <CardContent>
                        ...
                        <div className="mt-2">
                            <Progress value={dashboardData.performance_overview.risk_assessment_score} className="h-2" />
                        </div>
                        <p className="text-xs text-muted-foreground mt-2">
                        ...
                        <div className="flex items-center justify-between">
                            <div>
                                <strong className="text-amber-800 dark:text-amber-200">
                                    {dashboardData.active_alerts.length} Active KPI Alert{dashboardData.active_alerts.length > 1 ? 's' : ''}
                                </strong>
                                <div className="text-sm text-amber-700 dark:text-amber-300 mt-1">
                                    {dashboardData.active_alerts[0].alert_name}
                                    {dashboardData.active_alerts.length > 1 && ` and ${dashboardData.active_alerts.length - 1} more`}
                                </div>
                            </div>
                ...
                <TabsContent value="overview" className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        {dashboardData.featured_kpis.slice(0, 4).map((featuredKPI, index) => (
                            <Card key={index} className="hover:shadow-md transition-shadow cursor-pointer" onClick={() => showKPIAnalysis(featuredKPI.kpi.id)}>
                                <CardHeader>
                                    <CardTitle className="flex items-center justify-between">
                                        ...
                                        <div className="flex items-center gap-2">
                                            ...
                                            <Badge className={getPerformanceColor(featuredKPI.performance_rating)} variant="outline">
                                    ...
                                    <div className="flex items-center justify-between mb-4">
                                        <div>
                                            ...
                                            {featuredKPI.current_value?.variance_percentage && (
                                                <div className={`text-sm ${featuredKPI.current_value.variance_percentage >= 0 ? 'text-green-600' : 'text-red-600'}`}>
                            ...
                            <Card key={index} className="hover:shadow-lg transition-shadow">
                                <CardContent className="p-6">
                                    <div className="flex items-start justify-between mb-4">
                                        ...
                                        <div className="flex items-center gap-2">
                                            {getTrendIcon(featuredKPI.current_value?.trend_direction || 'Stable', 'w-3 h-3')}
                                            <Badge
                                    ...
                                    <div className="flex justify-between items-center">
                                        <div className="text-xs text-muted-foreground">
                                            Updated: {new Date(featuredKPI.current_value?.created_at || '').toLocaleDateString()}
                                        </div>
                                        <Button
                                            variant="ghost"
                                            size="sm"
                                            ...
                                            {insight.current_value && insight.expected_value && (
                                                <div className="grid grid-cols-3 gap-4 text-sm mb-3">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div className="font-medium">{formatNumber(insight.expected_value)}</div>
                                                    </div>
                                                    <div>
                                                        <div className="text-muted-foreground">Variance</div>
                                                        <div className={`font-medium ${(insight.variance_percentage || 0) >= 0 ? 'text-green-600' : 'text-red-600'}`}>
                        ...
                        <Card>
                            ...
                            <CardContent>
                                <div className="space-y-3">
                                    {dashboardData.benchmark_comparison.peer_comparison.slice(0, 3).map((comparison, index) => (
                        ...
                        <Card>
                            ...
                            <CardContent className="text-center">
                                <div className="text-4xl font-bold text-green-600 mb-2">
                                    {Math.round((dashboardData.performance_overview.financial_health_score +
                                        dashboardData.performance_overview.operational_efficiency_score) / 2)}%
                                </div>
                                <p className="text-sm text-muted-foreground">
                                ...
                                {dashboardData.benchmark_comparison.peer_comparison.map((comparison, index) => (
                                    <div key={index} className="border rounded-lg p-4">
                                        <div className="flex items-center justify-between mb-2">
                                            ...
                                            <Badge variant={
                                                comparison.percentile_ranking >= 75 ? 'default' :
                                                    comparison.percentile_ranking >= 50 ? 'secondary' :
                                                        'outline'
                                            }>
                                                {comparison.percentile_ranking}th percentile
                                            </Badge>
                                        ...
                                        <div className="grid grid-cols-2 gap-4 text-sm">
                                            <div>
                                                ...
                                                <span className="font-medium">{formatNumber(comparison.company_value)}</span>
                                            </div>
                                            <div>
                                                <span className="text-muted-foreground">Industry Average: </span>
                                                <span className="font-medium">{formatNumber(comparison.industry_average)}</span>
                                            </div>
                                        </div>

                                        <div className="mt-3">
                                            <Progress
                                                value={Math.min(100, (comparison.company_value / comparison.industry_average) * 50)}
                                                className="h-2"
                                            />
                                        </div>
                                    </div>
                        ...
                        <CardContent>
                            <div className="space-y-4 text-sm">
                                <div>
                                    ...
                                    <p className="text-muted-foreground">
                                        Overall financial health score of {dashboardData.performance_overview.financial_health_score}%
                                        indicates strong performance across key financial metrics. Revenue targets are being met with
                                ...
                                <div>
                                    ...
                                    <p className="text-muted-foreground">
                                        Operational efficiency score of {dashboardData.performance_overview.operational_efficiency_score}%
                                        demonstrates effective process management. Continue focus on automation and
                                ...
                                <div>
                                    ...
                                    <ul className="space-y-2 text-muted-foreground">
                                        <li className="flex items-start gap-2">
                                            <span className="text-blue-600 mt-0.5">•</span>
                                            <span>Maintain current growth trajectory while monitoring market conditions</span>
                                        </li>
                                        <li className="flex items-start gap-2">
                                            <span className="text-blue-600 mt-0.5">•</span>
            ...
            <Dialog open={showAnalysisDialog} onOpenChange={setShowAnalysisDialog}>
                <DialogContent className="max-w-4xl max-h-[80vh] overflow-y-auto">
                    <DialogHeader>
                        <DialogTitle>
                            KPI Analysis: {kpiAnalysis?.kpi.kpi_name}
                        </DialogTitle>
                        <DialogDescription>
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="grid grid-cols-3 gap-4 text-center">
                                <div>
                                    ...
                                    <Badge className={getPerformanceColor(kpiAnalysis.current_performance.rating)} variant="outline">
                                        {kpiAnalysis.current_performance.rating}
                                    </Badge>
                                </div>
                                <div>
                                    <div className="text-sm font-medium text-muted-foreground">Variance from Target</div>
                                    <div className={`text-2xl font-bold ${kpiAnalysis.current_performance.variance_percentage >= 0 ? 'text-green-600' : 'text-red-600'
                                        }`}>
                                        {formatPercentage(kpiAnalysis.current_performance.variance_percentage)}
                                    </div>
                                    <div className="text-sm text-muted-foreground">
                                        {formatNumber(Math.abs(kpiAnalysis.current_performance.variance_from_target))} from target
                                    </div>
                                </div>
                                <div>
