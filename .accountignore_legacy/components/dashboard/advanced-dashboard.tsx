    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Real-time analytics and KPI monitoring</p>
        </div>
...
function DashboardWidget({
  ...
  return (
    <Card className="h-full">
      ...
      <CardContent className="pt-0">{renderWidget()}</CardContent>
    </Card>
  );
}
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between text-sm">
            ...
            <span className="font-medium">
              {getKPIValue(widget.config.kpiType, kpiData.benchmark)}
            </span>
          </div>
...
function GaugeWidget({ widget, data, formatPercentage }: GaugeWidgetProps) {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="text-center text-sm text-muted-foreground">{widget.title}</div>
    </div>
  );
}
