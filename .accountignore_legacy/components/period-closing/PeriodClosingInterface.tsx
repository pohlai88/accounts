                        ...
                        <div className="space-y-4">
                            {selectedPeriod && (
                                <Alert>
                                    ...
                                    <AlertDescription>
                                        <strong>Warning:</strong> Closing period {selectedPeriod.period} {selectedPeriod.fiscalYear} will:
                    ...
                    <div className="space-y-4">
                        {selectedPeriod && (
                            <Alert>
                                <AlertTriangle className="h-4 w-4" />
                                <AlertDescription>
                                    <strong>Caution:</strong> Reopening period {selectedPeriod.period} {selectedPeriod.fiscalYear} will:
                                    <ul className="list-disc list-inside mt-2 space-y-1">
