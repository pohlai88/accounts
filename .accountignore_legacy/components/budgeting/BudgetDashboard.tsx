        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {formatCurrency(analytics.total_budget_amount)}
              </div>
              <p className="text-xs text-muted-foreground">Budgeted for FY {selectedFiscalYear}</p>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              ...
              <TrendingUp
                className={`h-4 w-4 ${getVarianceColor(analytics.overall_variance_percentage)}`}
              />
            </CardHeader>
            <CardContent>
              <div
                className={`text-2xl font-bold ${getVarianceColor(analytics.overall_variance_percentage)}`}
              >
                {formatPercentage(analytics.overall_variance_percentage)}
              </div>
              <p className="text-xs text-muted-foreground">
                {formatCurrency(Math.abs(analytics.total_variance_amount))}{" "}
                {analytics.total_variance_amount >= 0 ? "over" : "under"} budget
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">Historical forecast precision</p>
            </CardContent>
          </Card>
        </div>
      )}
                      ...
                      <tr key={budget.id} className="border-b hover:bg-muted/50">
                        ...
                        <td className="p-3">
                          <div className="font-medium">
                            {formatCurrency(budget.total_budgeted_amount)}
                          </div>
                        </td>
                        <td className="p-3">
                          <div className="font-medium">
                        ...
                        <td className="p-3">
                          <div
                            className={`font-medium ${getVarianceColor(budget.variance_percentage)}`}
                          >
