            ...
            <div className="flex justify-between items-center">
                <div>
                    ...
                    <p className="text-muted-foreground">
                        Employee expenses, receipts, and reimbursements
                    </p>
                </div>
                                    ...
                                    <tbody>
                                        {claims.map((claim) => (
                                            <tr key={claim.id} className="border-b hover:bg-muted/50">
                                                ...
                                                <td className="p-3">
                                                    <div className="font-medium">{formatCurrency(claim.total_claimed_amount)}</div>
                                ...
                                <CardContent className="space-y-4">
                                    <div className="flex items-center justify-between">
                                        ...
                                        <div className="text-right">
                                            <div className="font-medium">{analytics.receipt_compliance_rate.toFixed(1)}%</div>
