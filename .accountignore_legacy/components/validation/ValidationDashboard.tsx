...
export function ValidationDashboard({ companyId, refreshInterval = 30000 }: ValidationDashboardProps) {
    const [metrics, setMetrics] = useState<ValidationMetrics | null>(null)
    const [recentEvents, setRecentEvents] = useState<ValidationEvent[]>([])
    const [alerts, setAlerts] = useState<PerformanceAlert[]>([])
    const [healthStatus, setHealthStatus] = useState<ReturnType<typeof validationTelemetry.getHealthStatus> | null>(null)
        ...
        <div className="space-y-6">
            ...
            {criticalAlerts.length > 0 && (
                <Alert variant="destructive">
                    ...
                    <AlertDescription>
                        ...
                        <Button variant="link" className="p-0 h-auto ml-2" onClick={() => setSelectedTab('alerts')}>
                            View Details
                        </Button>
                    </AlertDescription>
                </Alert>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <Card>
                    ...
                    <CardContent>
                        <div className="text-2xl font-bold">
                            {metrics.validationCount.toLocaleString()}
                        </div>
                        <p className="text-xs text-muted-foreground mt-2">
                            Recent period
                        </p>
                ...
                <Card>
                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                        ...
                        <AlertTriangle className={`h-4 w-4 ${alerts.length > 0 ? 'text-red-600' : 'text-gray-400'}`} />
                    </CardHeader>
                    <CardContent>
                        <div className="text-2xl font-bold">
                            {alerts.length}
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Overall validation system performance
                                </CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-4">
                                <div className="space-y-2">
                                    <div className="flex justify-between">
                                        ...
                                        <Badge variant={performanceReport.grade === 'A' ? 'default' :
                                            performanceReport.grade === 'B' ? 'secondary' : 'destructive'}>
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Most frequent validation issues
                                </CardDescription>
                            </CardHeader>
                            <CardContent>
                                <div className="space-y-2">
                ...
                <TabsContent value="events" className="space-y-4">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Latest validation activities and outcomes
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <div className="space-y-3 max-h-96 overflow-y-auto">
                                {alerts.map((alert) => (
                                    <Alert key={alert.alertId} variant={
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Validation performance percentiles
                                </CardDescription>
                            </CardHeader>
                            <CardContent>
                                <div className="space-y-4">
                                    ...
                                    <div className="flex justify-between items-center">
                                        ...
                                        <span className="font-medium">{metrics.averageProcessingTime.toFixed(2)}ms</span>
                                    </div>
                                </div>
                            </CardContent>
                        </Card>
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Overall validation system status
                                </CardDescription>
                            </CardHeader>
                            <CardContent>
                                <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Validation errors by type and frequency
                                </CardDescription>
                            </CardHeader>
                            <CardContent>
                                <div className="space-y-2">
                                    {Object.entries(metrics.errorsByCode)
                                        .sort((a, b) => b[1] - a[1])
                                        .map(([code, count]) => (
                                            <div key={code} className="flex justify-between items-center p-2 border rounded">
                                                <span className="text-sm font-mono">{code}</span>
                                                <div className="flex items-center space-x-2">
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Validation warnings by type and frequency
                                </CardDescription>
                            </CardHeader>
                            <CardContent>
                                <div className="space-y-2">
