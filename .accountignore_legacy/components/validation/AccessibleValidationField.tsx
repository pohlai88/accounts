...
export const ValidationSummary: React.FC<ValidationSummaryProps> = ({
    ...
    const validFields = fieldValidations.filter(field =>
        !validation.hasFieldErrors(field) && !validation.hasFieldWarnings(field)
    )
                ...
                <div className="border-t pt-4">
                    ...
                    <div className="space-y-2 text-sm">
                        <div className="flex justify-between">
                            <span>Status:</span>
                            <span className={voucherSummary.isValid ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'}>
                        ...
                        {voucherSummary.warningCount > 0 && (
                            <div className="flex justify-between">
                                <span>Warnings:</span>
                                <span className="text-yellow-600 dark:text-yellow-400">{voucherSummary.warningCount}</span>
                            </div>
                        )}
                    </div>
                </div>
    ...
    return (
        <div className={cn('space-y-2', className)}>
            <div className="flex justify-between text-sm">
                ...
                <span>{validatedFields.length} / {fields.length} fields</span>
            </div>
            ...
            <div className="text-xs text-gray-600 dark:text-gray-400">
                ...
                {hasErrors && (
                    <span className="text-red-600 dark:text-red-400">{errorFields.length} field(s) have errors ❌</span>
                )}
            </div>
        </div>
    )
