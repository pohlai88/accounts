...
import { MetadataManagementService, EntityType, DataQualityMetrics, DataLineage, DataTag, DataChangeHistory } from '@/lib/metadata-management'
                    ...
                    <CardContent>
                        <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
                            <div className="text-center">
                                <div className="text-2xl font-bold text-blue-600">{qualityMetrics.completenessScore.toFixed(1)}%</div>
                                <div className="text-sm text-muted-foreground">Completeness</div>
                                <Progress value={qualityMetrics.completenessScore} className="h-2 mt-2" />
                            </div>
                            <div className="text-center">
                                <div className="text-2xl font-bold text-green-600">{qualityMetrics.accuracyScore.toFixed(1)}%</div>
                                <div className="text-sm text-muted-foreground">Accuracy</div>
                                <Progress value={qualityMetrics.accuracyScore} className="h-2 mt-2" />
                            </div>
                            <div className="text-center">
                                <div className="text-2xl font-bold text-purple-600">{qualityMetrics.consistencyScore.toFixed(1)}%</div>
                                <div className="text-sm text-muted-foreground">Consistency</div>
                                <Progress value={qualityMetrics.consistencyScore} className="h-2 mt-2" />
                            </div>
                            <div className="text-center">
                                <div className="text-2xl font-bold text-orange-600">{qualityMetrics.timelinessScore.toFixed(1)}%</div>
                            ...
                            <div className="text-center">
                                <div className={`text-2xl font-bold ${getQualityColor(qualityMetrics.overallScore).split(' ')[0]}`}>
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <div>
                                                ...
                                                <Select
                                                    ...
                                                    onValueChange={(value) => setNewTag(prev => ({ ...prev, tagCategory: value as any }))}
                                                >
                                                    <SelectTrigger>
                                                        <SelectValue />
                                                    </SelectTrigger>
