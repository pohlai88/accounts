    ...
    <div className="space-y-6">
          ...
          <DialogContent>
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-end gap-2">
                ...
                <Button onClick={handleSetupCompliance}>Setup Compliance</Button>
              </div>
            </div>
          </DialogContent>
        </Dialog>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Current compliance standards and their status</CardDescription>
        </CardHeader>
        <CardContent>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="space-y-2">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          {standard && <Badge variant="outline">{standard.country}</Badge>}
                        </div>
                      </div>
                      <div className="flex items-center gap-2">
