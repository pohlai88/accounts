        ...
        <div className="text-center space-y-6">
            <div className="space-y-4">
                ...
                <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                    You're about to experience accounting software that's 3x faster than QuickBooks,
                    more powerful than Xero, and more beautiful than anything else on the market.
                </p>
            </div>
            ...
            <div className="space-y-4">
                <p className="text-sm text-muted-foreground">
                    This setup will take about 3 minutes and will configure everything you need to get started.
                </p>
...
function CompanyStep({ data, onChange, onNext, onPrevious }: any) {
    const industries = [
        ...
        'Construction', 'Professional Services', 'Non-Profit', 'Other'
    ]
            ...
            <div className="grid grid-cols-1 gap-4">
                <div className="flex items-center justify-between p-4 border rounded-lg">
                    <div>
                        ...
                        <p className="text-sm text-muted-foreground">Handle transactions in multiple currencies</p>
                    </div>
                    <input
                        type="checkbox"
                ...
                <div className="flex items-center justify-between p-4 border rounded-lg">
                    <div>
                        ...
                        <p className="text-sm text-muted-foreground">Track expenses by department or location</p>
                    </div>
                    <input
                        type="checkbox"
    ...
    return (
        <div className="text-center space-y-6">
            <div className="space-y-4">
                ...
                <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                    Your Fortune 500-grade accounting system is ready. You now have access to
                    features that rival enterprise solutions at a fraction of the cost.
                </p>
            </div>
