...
export function ZeroFrictionWizard({ initialData, onComplete, onSkip }: ZeroFrictionWizardProps) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted">
      ...
      <div className="container mx-auto px-4 pb-8">
        <Card className="max-w-2xl mx-auto">
          ...
          <CardContent>
            {currentStep === 0 && <CompanyBasicsStep data={data} onChange={updateData} />}
            {currentStep === 1 && <OpeningBalancesStep data={data} onChange={updateData} />}
            {currentStep === 2 && <BankAccountsStep data={data} onChange={updateData} />}
            {currentStep === 3 && <TaxSettingsStep data={data} onChange={updateData} />}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <Card
          className={`cursor-pointer border-2 transition-colors ${
            data.has_opening_balances ? "border-primary bg-primary/5" : "border-border"
          }`}
        ...
        <Card
          className={`cursor-pointer border-2 transition-colors ${
            data.skip_opening_balances ? "border-primary bg-primary/5" : "border-border"
          }`}
        ...
        <div className="space-y-3">
          <div className="flex items-center space-x-2">
            <input
              ...
              className="h-4 w-4"
            />
            <Label htmlFor="sst_registered">SST Registered Business</Label>
          </div>
