...
const COACH_MARKS: CoachMark[] = [
    {
        ...
        description: 'Press ⌘K anywhere to search or create anything. Try typing "Create invoice" right now!',
    ...
    },
    {
        ...
        description: 'This invoice template is pre-configured for Malaysian businesses with SST calculations.',
    ...
    },
    {
        ...
        description: 'Your MFRS-aligned COA is ready. You can post transactions without touching this, but it\'s here if you need it.',
    ...
    },
    {
        ...
        description: 'Match 2 transactions to feel the speed. Our reconciliation engine is lightning fast.',
    ...
    },
    {
        id: 'audit-log',
        title: 'Audit Trail',
        description: 'Everything you do is tracked by user and time. This is your compliance superpower.',
        ...
        <>
            ...
            <div
                ...
                style={{
                    ...
                    transform: currentMark.position === 'top' || currentMark.position === 'bottom'
                        ? 'translateX(-50%)'
