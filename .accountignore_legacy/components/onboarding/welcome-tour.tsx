...
export function WelcomeTour({ isOpen, onClose, onComplete }: WelcomeTourProps) {
    ...
    const tourSteps: TourStep[] = [
        {
            ...
            description: 'You\'re now using the most advanced accounting software available. Let\'s take a quick tour of the key features that will save you hours every week.',
        ...
        },
        {
            ...
            description: 'Create invoices, record payments, and manage journal entries with real-time validation. Our ERPNext-inspired engine prevents errors before they happen.',
        ...
        },
        {
            ...
            description: 'Your account hierarchy is automatically configured with intelligent templates. Add, edit, or reorganize accounts with drag-and-drop simplicity.',
            target: 'accounts-tab',
            position: 'bottom',
            icon: DollarSign
        },
        {
            ...
            description: 'Generate trial balance, P&L, and balance sheet reports instantly. No waiting, no manual calculations - everything updates in real-time.',
            target: 'reports-tab',
            position: 'bottom',
            icon: TrendingUp
        },
        {
            ...
            description: 'Manage your profile, invite team members, and configure company preferences. Role-based permissions keep your data secure.',
            target: 'settings-tab',
            position: 'bottom',
            icon: Settings
        },
        {
            ...
            description: 'You now have access to Fortune 500-grade accounting features. Start by creating your first invoice or exploring the sample data we\'ve prepared.',
    ...
    return (
        <>
            ...
            {/* Tour Card */}
            <div className="fixed z-[60] tour-card" style={{
