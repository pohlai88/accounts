                ...
                <TabsContent value="configs" className="space-y-4">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Manage your analysis and pivot table configurations
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                            <ConfigurationsList
...
function AnalysisTreeNode({
    ...
    return (
        <div className="space-y-1">
            <div
                className={`flex items-center justify-between p-3 border rounded-lg hover:bg-muted/50 ${node.level === 0 ? 'bg-primary/5 border-primary/20' : ''
                    }`}
            ...
            >
                ...
                <div className="flex items-center space-x-4">
                    <div className="text-right">
                        ...
                        {node.variance && (
                            <p className="text-sm text-muted-foreground">
                                Var: {formatCurrency(node.variance)}
                            </p>
                        )}
                    </div>
