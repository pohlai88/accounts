        ...
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                ...
                <Dialog open={showAddRateDialog} onOpenChange={setShowAddRateDialog}>
                    ...
                    <DialogContent>
                        <AddExchangeRateForm onSuccess={handleAddExchangeRate} onCancel={() => setShowAddRateDialog(false)} />
                    </DialogContent>
                </Dialog>
            </div>
                ...
                <TabsContent value="currencies" className="space-y-4">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Manage currencies for your business operations
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                ...
                <TabsContent value="rates" className="space-y-4">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Current exchange rates and historical data
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
            ...
            <div className="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <Select
                        ...
                        onValueChange={(value: CurrencyCode) => setFormData({ ...formData, fromCurrency: value })}
                    >
                        <SelectTrigger>
                            <SelectValue />
                        </SelectTrigger>
                ...
                <div className="p-4 bg-muted rounded-lg">
                    <div className="text-center">
                        ...
                        <p className="text-sm text-muted-foreground mt-2">
                            Rate: {conversion.rate.toFixed(6)}
                        </p>
                    </div>
                </div>
            )}
            ...
            {loading ? (
                ...
                <div className="space-y-2">
                    {performance.map(item => (
                        <div key={item.currency} className="flex items-center justify-between p-3 border rounded-lg">
                            <div className="flex items-center space-x-3">
                            ...
                            <div className="flex items-center space-x-2">
                                ...
                                <span className={`font-bold ${item.change_percent > 0 ? 'text-green-600' :
