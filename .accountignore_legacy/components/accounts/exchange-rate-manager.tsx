...
export function ExchangeRateManager({ companyId }: ExchangeRateManagerProps) {
  ...
  const loadBulkRates = async () => {
    ...
    try {
      ...
      const result = await ExchangeRateAPIService.getBulkExchangeRates(
        selectedCurrency,
        currencies,
      );
      ...
      {apiStatus && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>Exchange rate API providers and their status</CardDescription>
          </CardHeader>
          <CardContent>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {rates.map(rate => (
                      <div key={`${rate.from}-${rate.to}`} className="p-4 border rounded-lg">
                        ...
                        <div className="text-2xl font-bold mb-1">{rate.rate.toFixed(4)}</div>
                        <div className="text-sm text-muted-foreground">
        ...
        <TabsContent value="bulk" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Exchange rates for a specific base currency</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                  ...
                  <div className="space-y-4">
                    <div className="p-4 bg-muted rounded-lg">
                      <p className="text-sm font-medium">
                        Base Currency: {bulkRates.base} | Date: {bulkRates.date} | Provider:{" "}
                        {bulkRates.provider}
                      </p>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <TabsContent value="settings" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Configure exchange rate API providers and settings</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                ...
                <div className="p-4 border rounded-lg">
                  ...
                  <p className="text-sm text-muted-foreground">
                    When primary providers fail, the system will use cached rates or fallback to USD
