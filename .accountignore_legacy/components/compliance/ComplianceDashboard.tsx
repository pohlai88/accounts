...
export default function ComplianceDashboard() {
    ...
    const [auditLogs, setAuditLogs] = useState<{ logs: SystemAuditLog[]; total: number; page: number; limit: number } | null>(null)
                    ...
                    <Card>
                        ...
                        <CardContent>
                            ...
                            <p className="text-xs text-muted-foreground mt-2">
                                {dashboard.effective_controls}/{dashboard.total_security_controls} controls effective
                            </p>
                        </CardContent>
                    </Card>
                    ...
                    <Card>
                        ...
                        <CardContent>
                            ...
                            <p className="text-xs text-muted-foreground">
                                {dashboard.overdue_dsr_count} overdue
                            </p>
                        </CardContent>
                    </Card>
                            ...
                            <CardTitle className="flex items-center justify-between">
                                ...
                                <div className="flex gap-2">
                                    <select
                                        ...
                                        onChange={(e) => setSelectedStatus(e.target.value as ImplementationStatus | 'All')}
                                    ...
                                    <tbody>
                                        {securityControls.map((control) => (
                                            <tr key={control.id} className="border-b hover:bg-muted/50">
                                                ...
                                                <td className="p-3">
                                                    <Badge variant="outline" className={getRiskLevelColor(control.risk_level)}>
                                                        {control.risk_level}
                                                    </Badge>
                                                </td>
                                                <td className="p-3">
                                    ...
                                    <tbody>
                                        {dataSubjectRequests.slice(0, 10).map((request) => (
                                            <tr key={request.id} className="border-b hover:bg-muted/50">
                                                ...
                                                <td className="p-3">
                                                    <div>
                                                        <div className="font-medium text-sm">{request.data_subject_name || 'Anonymous'}</div>
                                                        <div className="text-xs text-muted-foreground">{request.data_subject_email}</div>
                                                    </div>
                                                </td>
                                                <td className="p-3">
                                                ...
                                                <td className="p-3">
                                                    <div className={`text-sm ${new Date(request.due_date) < new Date() && !['Completed', 'Rejected'].includes(request.status)
                                                            ? 'text-red-600 font-medium'
                                                            : ''
                                                        }`}>
                                                        {new Date(request.due_date).toLocaleDateString()}
                                                    </div>
                                                    {new Date(request.due_date) < new Date() && !['Completed', 'Rejected'].includes(request.status) && (
                                        ...
                                        {dataBreaches.slice(0, 10).map((incident) => (
                                            <tr key={incident.id} className="border-b hover:bg-muted/50">
                                                ...
                                                <td className="p-3">
                                                    ...
                                                    <div className="text-xs text-muted-foreground">
                                                        {incident.personal_data_involved ? 'Personal Data Involved' : 'No Personal Data'}
                                                    </div>
                                                </td>
                                                <td className="p-3">
                                                    <Badge variant="outline">
                                    ...
                                    <tbody>
                                        {accessControls.slice(0, 10).map((access) => (
                                            <tr key={access.id} className="border-b hover:bg-muted/50">
                                                ...
                                                <td className="p-3">
                                                    <div className={`text-sm ${access.next_review_date && new Date(access.next_review_date) < new Date()
                                                            ? 'text-red-600 font-medium'
                                                            : ''
                                                        }`}>
                                                    ...
                                                    {access.next_review_date && new Date(access.next_review_date) < new Date() && (
                                    ...
                                    <tbody>
                                        {dataClassifications.slice(0, 10).map((classification) => (
                                            <tr key={classification.id} className="border-b hover:bg-muted/50">
                                                <td className="p-3">
                                                    <div className="font-medium text-sm">{classification.data_asset_name}</div>
                                                </td>
                                                <td className="p-3">
                                                    <Badge variant="outline">
                                                        {classification.data_asset_type}
                                                    </Badge>
                                                </td>
                                                <td className="p-3">
                                                    <Badge className={getClassificationColor(classification.classification_level)}>
