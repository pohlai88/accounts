...
export function CustomerManagement({ companyId }: CustomerManagementProps) {
    ...
    const getCustomerStatus = (customer: Customer) => {
        ...
        if (customer.outstanding_amount > customer.credit_limit * 0.8) return { label: 'High Risk', color: 'red' }
        if (customer.outstanding_amount > customer.credit_limit * 0.5) return { label: 'Medium Risk', color: 'yellow' }
                                        ...
                                        <TableRow key={customer.id} className="hover:bg-gray-50">
                                            ...
                                            <TableCell className="text-right">
                                                ...
                                                <div className="text-xs text-muted-foreground">
                                                    {((customer.outstanding_amount / customer.credit_limit) * 100).toFixed(1)}% of limit
                                                </div>
                                            </TableCell>
                                            <TableCell>
                                                <Badge
