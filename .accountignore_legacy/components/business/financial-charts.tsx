            ...
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-muted-foreground">
                        {period ? `${format(period.current_period.from, 'MMM dd')} - ${format(period.current_period.to, 'MMM dd, yyyy')}` : 'Current Period'}
                    </p>
                </div>
                    ...
                    <CardContent className="p-6">
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-2xl font-bold">{formatAmount(processedData.totals.totalAssets)}</p>
                            </div>
                    ...
                    <CardContent className="p-6">
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-2xl font-bold">{formatAmount(processedData.totals.totalIncome)}</p>
                            </div>
                    ...
                    <CardContent className="p-6">
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-2xl font-bold">{formatAmount(processedData.totals.totalExpenses)}</p>
                            </div>
...
function BalanceSheetChart({
    ...
    return (
        <div className="space-y-6">
            ...
            <Card className={cn(
                'border-2',
                isBalanced ? 'border-green-200 bg-green-50 dark:bg-green-900/20' : 'border-red-200 bg-red-50 dark:bg-red-900/20'
            )}>
