...
export function TransactionBuilder({
    ...
    const validateTransaction = (): Record<string, string> => {
        ...
        // Minimum entries
        const validEntries = transaction.entries.filter(e => e.account_id && (e.debit > 0 || e.credit > 0))
    ...
    const hasValidEntries = transaction.entries.filter(e => e.account_id && (e.debit > 0 || e.credit > 0)).length >= 2
                ...
                <Alert variant="destructive">
                    ...
                    <AlertDescription className="flex items-center justify-between">
                        <span>
                            ...
                            (Debit: {transaction.total_debit.toLocaleString()}, Credit: {transaction.total_credit.toLocaleString()})
                        </span>
                                ...
                                {transaction.entries.map((entry, index) => (
                                    <div key={entry.id} className="grid grid-cols-12 gap-2 items-start">
                                        ...
                                        <div className="col-span-2">
                                            <AmountInput
                                                value={entry.debit}
                                                onChange={(amount) => updateEntry(entry.id, {
                                                    debit: amount || 0,
                                                    credit: 0
                                                })}
                                                placeholder="0.00"
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <Select
                                        ...
                                        onValueChange={(value) => setTransaction(prev => ({ ...prev, voucher_type: value }))}
                                    >
                                        <SelectTrigger>
                                            <SelectValue />
                                        </SelectTrigger>
                ...
                <div className="flex items-center space-x-2">
                    ...
                    {allowDraft && (
                        <Button
                            variant="outline"
                            onClick={handleSave}
                            disabled={loading || !hasValidEntries}
                        >
                    ...
                    <Button
                        ...
                        disabled={loading || !isBalanced || !hasValidEntries}
                    >
                ...
                <div className="grid grid-cols-2 gap-4 p-4 bg-muted rounded-lg">
                    ...
                    <div className="text-right">
                        <p className="font-semibold">
                            {format(transaction.posting_date, 'dd MMM yyyy')}
                        </p>
                        <p className="text-sm text-muted-foreground">
