        ...
        switch (status) {
            case 'verified':
                return {
                    ...
                    description: 'Your email has been verified. You\'ll be redirected to complete your account setup.',
            ...
            default:
                return {
                    ...
                    description: 'We\'ve sent a verification link to your email address. Click the link to verify your account and continue.',
