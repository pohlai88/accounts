...
import { SalesManagementService, CreateQuotationInput, SalesQuotation, QuotationStatus } from '@/lib/sales-management-service'
...
export function SalesQuotationForm({ companyId, quotation, onSuccess, onCancel }: SalesQuotationFormProps) {
