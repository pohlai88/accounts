...
export function DatePicker({
    ...
    const quickSelections = [
        ...
        { label: 'Start of Month', value: new Date(new Date().getFullYear(), new Date().getMonth(), 1) },
        { label: 'End of Month', value: new Date(new Date().getFullYear(), new Date().getMonth() + 1, 0) },
        {
