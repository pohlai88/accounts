...
export function CommandPalette({ isOpen, onClose }: CommandPaletteProps) {
    ...
    const getCategoryColor = (category: Command['category']) => {
        switch (category) {
            ...
            case 'navigate': return 'text-blue-600 bg-blue-50 dark:bg-blue-900/20'
            case 'search': return 'text-purple-600 bg-purple-50 dark:bg-purple-900/20'
            case 'ai': return 'text-yellow-600 bg-yellow-50 dark:bg-yellow-900/20'
            case 'quick': return 'text-orange-600 bg-orange-50 dark:bg-orange-900/20'
