...
export class EnhancedDocumentWorkflowEngine extends DocumentWorkflowEngine {
        ...
        try {
            ...
            switch (documentType) {
                ...
                case 'Journal Entry':
                    ...
                    break
                default:
                    coreSubmissionResult = await this.submitGenericDocument(documentType, documentId, context)
            }
            ...
            const documentLinks = await this.createDocumentLinks(
                documentType,
                documentId,
                context
            )
    ...
    static async approveDocument(
        ...
        try {
            ...
            const canApprove = await this.checkApprovalAuthorization(
                approval.id,
                approverId
            )
