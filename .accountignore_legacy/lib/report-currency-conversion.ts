...
export type CurrencyCode = 'USD' | 'EUR' | 'GBP' | 'MYR' | 'JPY' | 'CAD' | 'AUD' | 'SGD' | 'CNY' | 'INR'
...
export class ReportCurrencyConversionService {
    ...
    static async getCurrencyConversionSummary(
        ...
        try {
            ...
            if (!entries) {
                return { success: true, summary: { totalTransactions: 0, currenciesUsed: [], conversionRates: [], totalConvertedAmount: 0 } }
            }
