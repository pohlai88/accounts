    ...
    private static async createDefaultAccounts(companyId: string): Promise<void> {
        try {
            const defaultAccounts = [
                ...
                { name: 'Current Assets', account_type: 'Asset', account_code: '1100', is_group: true, parent_code: '1000' },
                { name: 'Cash', account_type: 'Asset', account_code: '1110', is_group: false, parent_code: '1100' },
                { name: 'Bank Account', account_type: 'Asset', account_code: '1120', is_group: false, parent_code: '1100' },
                { name: 'Accounts Receivable', account_type: 'Asset', account_code: '1130', is_group: false, parent_code: '1100' },
                
                // Liabilities
                { name: 'Liabilities', account_type: 'Liability', account_code: '2000', is_group: true },
                { name: 'Current Liabilities', account_type: 'Liability', account_code: '2100', is_group: true, parent_code: '2000' },
                { name: 'Accounts Payable', account_type: 'Liability', account_code: '2110', is_group: false, parent_code: '2100' },
                
                // Equity
                { name: 'Equity', account_type: 'Equity', account_code: '3000', is_group: true },
                { name: 'Owner Equity', account_type: 'Equity', account_code: '3100', is_group: false, parent_code: '3000' },
                
                // Income
                { name: 'Income', account_type: 'Income', account_code: '4000', is_group: true },
                { name: 'Sales Revenue', account_type: 'Income', account_code: '4100', is_group: false, parent_code: '4000' },
                
                // Expenses
                { name: 'Expenses', account_type: 'Expense', account_code: '5000', is_group: true },
                { name: 'Operating Expenses', account_type: 'Expense', account_code: '5100', is_group: false, parent_code: '5000' }
            ]
