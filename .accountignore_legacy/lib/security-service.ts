...
import type { User, UserRole, AuditLog, SecurityEvent, ComplianceStandard, CompanyCompliance } from './supabase'
...
export class SecurityService {
    ...
    static async updateUserProfile(userId: string, updates: Partial<CreateUserProfileInput>): Promise<{
        success: boolean
        user?: User
        error?: string
    }> {
