...
export class ProjectCostingService {
     ...
     */
    static async createProject(input: CreateProjectInput): Promise<{ success: boolean; project?: Project; error?: string }> {
        try {
     ...
     */
    static async getProjects(companyId: string): Promise<{ success: boolean; projects?: Project[]; error?: string }> {
        try {
            const { data, error } = await supabase
                .from('projects')
                .select('*')
     ...
     * Create a time entry
     */
    static async createTimeEntry(input: CreateTimeEntryInput): Promise<{ success: boolean; timeEntry?: TimeEntry; error?: string }> {
        try {
            const { data, error } = await supabase
                .from('time_entries')
                .insert({
     ...
     */
    static async createProjectExpense(input: CreateProjectExpenseInput): Promise<{ success: boolean; expense?: ProjectExpense; error?: string }> {
        try {
            const { data, error } = await supabase
     ...
     */
    static async getProjectProfitability(projectId: string): Promise<{ success: boolean; profitability?: ProjectProfitability; error?: string }> {
        try {
            const { data, error } = await supabase
                .rpc('calculate_project_profitability', {
     ...
     * Get project budgets
     */
    static async getProjectBudgets(projectId: string): Promise<{ success: boolean; budgets?: ProjectBudget[]; error?: string }> {
        try {
            const { data, error } = await supabase
