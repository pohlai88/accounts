...
export const MFRS_CHART_OF_ACCOUNTS = [
    ...
    { code: '1110', name: 'Cash and Cash Equivalents', type: 'Asset', is_group: false, parent_code: '1100' },
    { code: '1111', name: 'Petty Cash', type: 'Asset', is_group: false, parent_code: '1110' },
    { code: '1112', name: 'Bank - Current Account', type: 'Asset', is_group: false, parent_code: '1110' },
    { code: '1113', name: 'Bank - Savings Account', type: 'Asset', is_group: false, parent_code: '1110' },
    { code: '1114', name: 'Fixed Deposits', type: 'Asset', is_group: false, parent_code: '1110' },

    { code: '1120', name: 'Trade and Other Receivables', type: 'Asset', is_group: false, parent_code: '1100' },
    ...
    { code: '1210', name: 'Property, Plant and Equipment', type: 'Asset', is_group: false, parent_code: '1200' },
    ...
    { code: '1213', name: 'Furniture and Fittings', type: 'Asset', is_group: false, parent_code: '1210' },
    ...
    { code: '1220', name: 'Accumulated Depreciation', type: 'Asset', is_group: false, parent_code: '1200' },
    { code: '1230', name: 'Intangible Assets', type: 'Asset', is_group: false, parent_code: '1200' },
    { code: '1240', name: 'Long-term Investments', type: 'Asset', is_group: false, parent_code: '1200' },

    // LIABILITIES (2000-2999)
    { code: '2000', name: 'LIABILITIES', type: 'Liability', is_group: true, parent_code: null },

    // Current Liabilities (2100-2199)
    { code: '2100', name: 'Current Liabilities', type: 'Liability', is_group: true, parent_code: '2000' },
    { code: '2110', name: 'Trade and Other Payables', type: 'Liability', is_group: false, parent_code: '2100' },
    ...
    { code: '2113', name: 'Accrued Expenses', type: 'Liability', is_group: false, parent_code: '2110' },

    { code: '2120', name: 'Tax Payable', type: 'Liability', is_group: false, parent_code: '2100' },
    { code: '2121', name: 'Corporate Income Tax', type: 'Liability', is_group: false, parent_code: '2120' },
    { code: '2122', name: 'SST Output Tax', type: 'Liability', is_group: false, parent_code: '2120' },
    { code: '2123', name: 'Withholding Tax Payable', type: 'Liability', is_group: false, parent_code: '2120' },

    { code: '2130', name: 'Employee Benefits', type: 'Liability', is_group: false, parent_code: '2100' },
    ...
    { code: '2140', name: 'Short-term Borrowings', type: 'Liability', is_group: false, parent_code: '2100' },

    // Non-Current Liabilities (2200-2299)
    { code: '2200', name: 'Non-Current Liabilities', type: 'Liability', is_group: true, parent_code: '2000' },
    { code: '2210', name: 'Long-term Borrowings', type: 'Liability', is_group: false, parent_code: '2200' },
    { code: '2220', name: 'Deferred Tax Liabilities', type: 'Liability', is_group: false, parent_code: '2200' },
    ...
    { code: '3300', name: 'Current Year Earnings', type: 'Equity', is_group: false, parent_code: '3000' },
    { code: '3400', name: 'Opening Balance Equity', type: 'Equity', is_group: false, parent_code: '3000' },
    ...
    { code: '4240', name: 'Foreign Exchange Gain', type: 'Income', is_group: false, parent_code: '4200' },
    ...
    { code: '5110', name: 'Cost of Goods Sold', type: 'Expense', is_group: false, parent_code: '5100' },
    ...
    { code: '5200', name: 'Administrative Expenses', type: 'Expense', is_group: false, parent_code: '5000' },
    { code: '5210', name: 'Salaries and Wages', type: 'Expense', is_group: false, parent_code: '5200' },
    { code: '5211', name: 'EPF Contribution', type: 'Expense', is_group: false, parent_code: '5210' },
    { code: '5212', name: 'SOCSO Contribution', type: 'Expense', is_group: false, parent_code: '5210' },
    ...
    { code: '5233', name: 'Telephone and Internet', type: 'Expense', is_group: false, parent_code: '5230' },

    { code: '5240', name: 'Professional Fees', type: 'Expense', is_group: false, parent_code: '5200' },
    ...
    { code: '5250', name: 'Motor Vehicle Expenses', type: 'Expense', is_group: false, parent_code: '5200' },
    ...
    { code: '5290', name: 'Travel and Entertainment', type: 'Expense', is_group: false, parent_code: '5200' },

    { code: '5300', name: 'Marketing Expenses', type: 'Expense', is_group: false, parent_code: '5000' },
    ...
    { code: '5430', name: 'Foreign Exchange Loss', type: 'Expense', is_group: false, parent_code: '5400' },
]
