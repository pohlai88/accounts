...
export class EnhancedInvoiceService {
     ...
     */
    static async createInvoiceTemplate(input: CreateInvoiceTemplateInput): Promise<ApiResponse<InvoiceTemplate>> {
        try {
     ...
     */
    static async createInvoiceWorkflow(input: CreateInvoiceWorkflowInput): Promise<ApiResponse<InvoiceWorkflow>> {
        try {
     ...
     * Add workflow state
     */
    static async addWorkflowState(input: InvoiceWorkflowStateInput): Promise<ApiResponse<InvoiceWorkflowState>> {
        try {
     ...
     */
    static async addWorkflowTransition(input: InvoiceWorkflowTransitionInput): Promise<ApiResponse<InvoiceWorkflowTransition>> {
        try {
    ...
    static async sendInvoiceEmail(
        ...
        emailType: 'Invoice' | 'Payment Reminder' | 'Overdue Notice' | 'Payment Confirmation' = 'Invoice',
