...
export class InventoryManagementService {
     ...
     * Create a new item
     */
    static async createItem(input: CreateItemInput): Promise<{ success: boolean; item?: Item; error?: string }> {
        try {
     ...
     */
    static async getItems(companyId: string): Promise<{ success: boolean; items?: Item[]; error?: string }> {
        try {
            const { data, error } = await supabase
                .from('items')
                .select('*')
     ...
     */
    static async createWarehouse(input: CreateWarehouseInput): Promise<{ success: boolean; warehouse?: Warehouse; error?: string }> {
        try {
            const { data, error } = await supabase
                .from('warehouses')
                .insert({
     ...
     */
    static async getWarehouses(companyId: string): Promise<{ success: boolean; warehouses?: Warehouse[]; error?: string }> {
        try {
            const { data, error } = await supabase
                .from('warehouses')
                .select('*')
     ...
     */
    static async getStockSummary(companyId: string, warehouseId?: string): Promise<{ success: boolean; stockSummary?: any[]; error?: string }> {
        try {
            const { data, error } = await supabase
                .rpc('get_item_stock_summary', {
     ...
     * Get low stock items
     */
    static async getLowStockItems(companyId: string, warehouseId?: string): Promise<{ success: boolean; lowStockItems?: any[]; error?: string }> {
        try {
            const { data, error } = await supabase
     ...
     */
    static async createStockTransaction(input: CreateStockTransactionInput): Promise<{ success: boolean; transactionId?: string; error?: string }> {
        try {
            const { data, error } = await supabase
     ...
     * Get item pricing
     */
    static async getItemPricing(itemId: string): Promise<{ success: boolean; pricing?: ItemPricing[]; error?: string }> {
        try {
            const { data, error } = await supabase
                .from('item_pricing')
                .select('*')
