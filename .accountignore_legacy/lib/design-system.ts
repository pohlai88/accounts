...
export const components = {
    card: {
        ...
        elevated: 'bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-lg shadow-md',
        interactive: 'bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-200',
    },
...
export const utils = {
    ...
    getFinancialColor: (value: number, type: 'revenue' | 'expense' | 'profit' | 'loss' | 'balance' = 'balance') => {
