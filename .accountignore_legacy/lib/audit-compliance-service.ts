...
export interface AuditLog {
    ...
    table_name: string
    record_id: string
    operation_type: 'CREATE' | 'UPDATE' | 'DELETE' | 'LOGIN' | 'LOGOUT' | 'VIEW' | 'EXPORT' | 'IMPORT' | 'APPROVE' | 'REJECT'
...
export interface CompanyComplianceSettings {
    ...
    compliance_status: 'Not Assessed' | 'In Progress' | 'Compliant' | 'Non-Compliant' | 'Partially Compliant'
...
export class AuditComplianceService {
    ...
    static async logAuditEvent(
        ...
        tableName: string,
        recordId: string,
        operationType: 'CREATE' | 'UPDATE' | 'DELETE' | 'LOGIN' | 'LOGOUT' | 'VIEW' | 'EXPORT' | 'IMPORT' | 'APPROVE' | 'REJECT',
        options: {
     ...
     */
    static async getCompanyComplianceSettings(companyId: string): Promise<ApiResponse<CompanyComplianceSettings[]>> {
        try {
    ...
    static async createComplianceViolation(
        ...
        try {
            ...
            return { success: true, data: violation, message: 'Compliance violation created successfully' }
        } catch (error) {
     ...
     */
    static async getAuditStatistics(companyId: string): Promise<ApiResponse<{
