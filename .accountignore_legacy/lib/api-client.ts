...
export class ApiClient {
    ...
    // Sales Invoices
    async getSalesInvoices(params?: PaginationParams & {
        customer_id?: string
        status?: string
        from_date?: string
        to_date?: string
    ...
    // Quotations
    async getQuotations(params?: PaginationParams & {
        customer_id?: string
        status?: string
        from_date?: string
        to_date?: string
    ...
    // Fixed Assets
    async getFixedAssets(params?: PaginationParams & {
    ...
    // Treasury Management
    async getTreasuryForecasts(params?: PaginationParams & {
        company_id?: string
    ...
    async getBankingData(params?: PaginationParams & {
    ...
    // Tax Management
    async getTaxData(params?: PaginationParams & {
