...
export const handleValidationError = (errors: Record<string, string[]> | string[], context?: Record<string, any>) =>
...
export const handleAuthorizationError = (action: string, resource: string, context?: Record<string, any>) =>
...
export const handleBusinessRuleError = (rule: string, message: string, context?: Record<string, any>) =>
...
export const setupGlobalErrorHandling = () => {
    ...
    window.addEventListener('error', (event) => {
        handleSystemError(event.error, { type: 'uncaught', filename: event.filename, lineno: event.lineno })
    })
}
