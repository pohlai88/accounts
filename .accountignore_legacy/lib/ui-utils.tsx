...
export const getStatusBadge = (status: string) => {
  const statusConfig = {
    ...
    Submitted: { variant: 'default' as const, className: 'bg-primary/10 text-primary border-primary/20' },
    Approved: { variant: 'default' as const, className: 'bg-primary/10 text-primary border-primary/20' },
    Rejected: { variant: 'destructive' as const, className: 'bg-destructive/10 text-destructive border-destructive/20' },
    Completed: { variant: 'default' as const, className: 'bg-primary/10 text-primary border-primary/20' },
    ...
    Processing: { variant: 'default' as const, className: 'bg-primary/10 text-primary border-primary/20' },
    Paid: { variant: 'default' as const, className: 'bg-primary/10 text-primary border-primary/20' },
    Failed: { variant: 'destructive' as const, className: 'bg-destructive/10 text-destructive border-destructive/20' },
    Overdue: { variant: 'destructive' as const, className: 'bg-destructive/10 text-destructive border-destructive/20' },
    ...
    // Compliance Status
    Compliant: { variant: 'default' as const, className: 'bg-primary/10 text-primary border-primary/20' },
    'Non-Compliant': { variant: 'destructive' as const, className: 'bg-destructive/10 text-destructive border-destructive/20' },
    'Partially Compliant': { variant: 'secondary' as const, className: 'bg-muted text-muted-foreground' },
