        ...
        <div className="container mx-auto py-6 space-y-6">
            ...
            <div className="text-center space-y-4">
                ...
                <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                    Professional-grade data export, API management, third-party integrations,
                    and backup solutions for enterprise accounting systems
                </p>
            </div>
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        Seamlessly connect with your favorite business tools
                    </CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        Bank-level security for all your data operations
                    </CardDescription>
                </CardHeader>
                <CardContent>
