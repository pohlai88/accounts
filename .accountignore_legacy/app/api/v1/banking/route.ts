...
const bankAccountSchema = z.object({
    ...
    account_type: z.enum(['Checking', 'Savings', 'Credit Card', 'Money Market', 'Certificate of Deposit']).default('Checking'),
    ...
    integration_provider: z.enum(['Manual', 'Plaid', 'Yodlee', 'Open Banking', 'CSV Import']).default('Manual'),
...
const bankTransactionSchema = z.object({
    ...
    transaction_type: z.enum(['Deposit', 'Withdrawal', 'Transfer', 'Fee', 'Interest', 'Other']).default('Other'),
...
const querySchema = z.object({
    ...
    is_reconciled: z.string().optional().transform(val => val === 'true'),
    transaction_type: z.string().optional(),
    search: z.string().optional(),
    sort_by: z.enum(['transaction_date', 'debit_amount', 'credit_amount', 'account_name']).default('transaction_date'),
...
async function getBankAccounts(params: any) {
    ...
    if (params.search) {
        query = query.or(`account_name.ilike.%${params.search}%,bank_name.ilike.%${params.search}%,account_number.ilike.%${params.search}%`)
    }
