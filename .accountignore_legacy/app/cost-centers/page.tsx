        ...
        return costCenters
            ...
            .map(costCenter => (
                <div key={costCenter.id}>
                    <div className={`flex items-center py-3 px-4 hover:bg-gray-50 dark:hover:bg-gray-800 rounded-md border-b ${level > 0 ? 'ml-8' : ''}`}>
                        {costCenter.isGroup && (
                            <Button
                                variant="ghost"
                                size="sm"
                        ...
                        <div className="flex-1 grid grid-cols-1 md:grid-cols-6 gap-4 items-center">
                            ...
                            <div className="flex items-center md:col-span-2">
                                ...
                                <div>
                                    ...
                                    {costCenter.isGroup && (
                                        <Badge variant="secondary" className="text-xs mt-1">Group</Badge>
                                    )}
                                </div>
                            </div>
                            ...
                            {/* Utilization */}
                            <div className="text-center">
                                <div className={`text-sm font-medium ${getBudgetUtilizationColor(costCenter.budgetUtilization || 0)}`}>
        ...
        <div className="max-w-7xl mx-auto p-6 space-y-6">
                    ...
                    <div className="space-y-4">
                        <div>
                            ...
                            <Input
                                ...
                                onChange={(e) => setNewCostCenter(prev => ({ ...prev, costCenterName: e.target.value }))}
                        ...
                        <div>
                            ...
                            <Input
                                ...
                                onChange={(e) => setNewCostCenter(prev => ({ ...prev, costCenterCode: e.target.value }))}
                        ...
                        <div>
                            ...
                            <Select
                                ...
                                onValueChange={(value) => setNewCostCenter(prev => ({ ...prev, parentCostCenter: value }))}
                            >
                                <SelectTrigger>
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        Test the cost center selector component
                    </CardDescription>
                </CardHeader>
                <CardContent>
                    <CostCenterSelector
