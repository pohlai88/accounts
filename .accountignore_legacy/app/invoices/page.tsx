    ...
    <div className="max-w-7xl mx-auto p-6 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div>
              ...
              <Select
                ...
                onValueChange={value =>
                  setFilters(prev => ({ ...prev, invoice_type: value as any }))
                }
              >
                <SelectTrigger>
                  <SelectValue />
                ...
                <TableBody>
                  {invoices.map(invoice => (
                    <TableRow key={invoice.id}>
                      ...
                      <TableCell>{invoice.customer_name || invoice.supplier_name}</TableCell>
                      <TableCell>
      ...
      <Dialog open={showCreateDialog} onOpenChange={setShowCreateDialog}>
        <DialogContent className="max-w-6xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle>Create {invoiceType} Invoice</DialogTitle>
            <DialogDescription>
            ...
            <ERPNextEnhancedSalesInvoiceForm
              ...
              onSave={data => {
                ...
                const invoice: Invoice = {
                  ...
                  tax_total: data.items.reduce(
                    (sum, item) => sum + item.qty * item.rate * (item.tax_rate / 100),
                    0,
                  ),
                  grand_total: data.items.reduce(
                    (sum, item) => sum + item.qty * item.rate * (1 + item.tax_rate / 100),
                    0,
                  ),
                  outstanding_amount: data.items.reduce(
                    (sum, item) => sum + item.qty * item.rate * (1 + item.tax_rate / 100),
                    0,
                  ),
                  status: "Draft",
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <div className="space-y-1 text-sm">
                    <p>
                      <span className="font-medium">Invoice No:</span> {selectedInvoice.invoice_no}
                    </p>
                    <p>
                ...
                <div>
                  ...
                  <div className="space-y-1 text-sm">
                    ...
                    <p>
                      <span className="font-medium">Currency:</span> {selectedInvoice.currency}
                    </p>
                    <p>
