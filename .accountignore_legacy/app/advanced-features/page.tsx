    ...
    const features = [
        {
            ...
            description: 'Automate recurring transactions like monthly rent, subscriptions, and regular payments',
            icon: RefreshCw,
        ...
        <div className="max-w-7xl mx-auto p-6 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {features.map((feature) => {
                    ...
                    const isAvailable = feature.id === 'recurring' || feature.id === 'reconciliation' || feature.id === 'inventory' || feature.id === 'projects' || feature.id === 'budgets' || feature.id === 'tax' || feature.id === 'fixed-assets' || feature.id === 'quick-wins'

                    return (
                        <Card
                            key={feature.id}
                            className={`transition-all ${isAvailable
