                    ...
                    <CardContent className="p-4">
                        <div className="flex items-center space-x-2">
                            ...
                            <div>
                                ...
                                <p className="text-2xl font-bold">{formatCurrency(inventoryStats?.total_stock_value || 0)}</p>
                            </div>
                        </div>
                    </CardContent>
                </Card>
                        ...
                        <TableBody>
                            {items.map((item) => (
                                <TableRow key={item.id}>
                                    ...
                                    <TableCell>
                                        {getStatusBadge(item.is_active ? 'Active' : 'Inactive')}
                                    </TableCell>
                                    <TableCell>
                            ...
                            {stockEntries.map((entry) => (
                                <TableRow key={entry.id}>
                                    <TableCell>
                                        <div className="flex items-center space-x-3">
                                            <div className="flex-shrink-0">
                                                {getStockEntryTypeIcon(entry.entry_type)}
                                            </div>
                                            <div>
                                    ...
                                    <TableCell>
                                        {getStatusBadge(
                                            entry.docstatus === 0 ? 'Draft' :
                                                entry.docstatus === 1 ? 'Submitted' : 'Cancelled'
                                        )}
                                    </TableCell>
                                    <TableCell>
                                        <div className="flex space-x-1">
        ...
        <div className="space-y-4">
            ...
            {loading ? (
                ...
                <div className="text-center py-8">
                    ...
                    <p className="text-muted-foreground">Stock balance will appear after stock transactions</p>
                </div>
            ) : (
                <div className="border rounded-lg">
                    <Table>
                            ...
                            {bins.map((bin) => {
                                ...
                                return (
                                    <TableRow key={bin.id}>
                                        ...
                                        <TableCell>
                                            <div className="text-right font-medium">
                                                {bin.actual_qty.toFixed(2)}
                                            </div>
                                        </TableCell>
                                        <TableCell>
                                            <div className="text-right">
                                                {bin.reserved_qty.toFixed(2)}
                                            </div>
                                        </TableCell>
                                        <TableCell>
                                            <div className="text-right font-medium">
                                        ...
                                        <TableCell>
                                            <div className="text-right">
                                                {formatCurrency(bin.valuation_rate)}
                                            </div>
                                        </TableCell>
                                        <TableCell>
                                            {getStatusBadge(
                                                bin.actual_qty === 0 ? 'Out of Stock' :
