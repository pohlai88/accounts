...
export default function PaymentProcessingPage() {
    ...
    const getStatusBadge = (status: string) => {
        const statusConfig = {
            ...
            Processing: { variant: 'default' as const, label: 'Processing', color: 'bg-blue-100 text-blue-800' },
                                ...
                                <TableRow key={payment.id}>
                                    ...
                                    <TableCell>
                                        <Badge variant="outline" className={
                                            payment.payment_type === 'Received' ? 'text-green-600 border-green-200' :
                                                payment.payment_type === 'Paid' ? 'text-red-600 border-red-200' :
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <Card>
                                    ...
                                    <CardContent className="space-y-2">
                                        ...
                                        <div className="flex justify-between">
                                            <span>Amount:</span>
                                            <span className="font-medium">{selectedPayment.currency} {selectedPayment.amount.toFixed(2)}</span>
                                        </div>
                                        <div className="flex justify-between">
                                            <span>Date:</span>
                                ...
                                <Card>
                                    ...
                                    <CardContent className="space-y-2">
                                        ...
                                        <div className="flex justify-between">
                                            <span>Created:</span>
                                            <span>{format(new Date(selectedPayment.created_at), 'MMM dd, yyyy HH:mm')}</span>
                                        </div>
                                    </CardContent>
                                </Card>
                            </div>
