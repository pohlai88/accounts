...
export const metadata = {
    ...
    description: 'Comprehensive budget variance analysis with drill-down capabilities, automated alerts, and AI-powered recommendations for CFO-level financial performance management.'
}
