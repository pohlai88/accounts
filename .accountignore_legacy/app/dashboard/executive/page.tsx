...
export const metadata = {
    ...
    description: 'Comprehensive executive dashboard with real-time KPI monitoring, AI-powered financial insights, performance benchmarking, and strategic recommendations for C-level decision making.'
}
