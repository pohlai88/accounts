                ...
                {profile.company_id ? (
                    <Tabs defaultValue="transactions" className="space-y-6">
                        <TabsList className="grid w-full grid-cols-4">
                            <TabsTrigger value="transactions" className="flex items-center space-x-2" id="transactions-tab">
                                <FileText className="h-4 w-4" />
                                <span>Transactions</span>
                            </TabsTrigger>
                            <TabsTrigger value="accounts" className="flex items-center space-x-2" id="accounts-tab">
                            ...
                            <TabsTrigger value="settings" className="flex items-center space-x-2" id="settings-tab">
                                ...
                                <Card>
                                    ...
                                    <CardContent className="space-y-4">
                                        <div>
                                            ...
                                            <p className="text-sm text-muted-foreground font-mono">{profile.company_id}</p>
                                        </div>
                                        <div>
                    ...
                    <div className="text-center space-y-6">
                        ...
                        <Card className="max-w-md mx-auto">
                            ...
                            <CardContent className="space-y-4">
                                <p className="text-sm text-muted-foreground">
                                    Contact your administrator to get access to a company, or create a new account
                                    if you need to set up a new company.
                                </p>
                                <div className="space-y-2">
