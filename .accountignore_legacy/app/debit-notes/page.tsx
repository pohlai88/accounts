...
export default function DebitNotesPage() {
    ...
    useEffect(() => {
        ...
        // Apply search filter
        if (searchTerm) {
            filtered = filtered.filter(debitNote =>
        ...
        <div className="max-w-7xl mx-auto p-6 space-y-6">
            ...
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-muted-foreground mt-2">
                        Manage debit notes and supplier adjustments
                    </p>
                </div>
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        {filteredDebitNotes.length} debit notes found
                    </CardDescription>
                </CardHeader>
                <CardContent>
                    {loading ? (
                                ...
                                <TableBody>
                                    {filteredDebitNotes.map((debitNote) => (
                                        <TableRow key={debitNote.id}>
                                            ...
                                            <TableCell>
                                                <div>
                                                    <div className="font-medium">{debitNote.customer_name || debitNote.supplier_name}</div>
                                                    <div className="text-sm text-muted-foreground">
                                            ...
                                            <TableCell>
                                                <div className="text-sm">
                                                    <div>Debit Note: {format(new Date(debitNote.invoice_date), 'MMM dd, yyyy')}</div>
                                                ...
                                                <div className="text-right">
                                                    ...
                                                    {debitNote.outstanding_amount !== 0 && (
                                                        <div className="text-xs text-muted-foreground">
                                                            Outstanding: {debitNote.currency} {debitNote.outstanding_amount.toFixed(2)}
                                                        </div>
                                                    )}
                                                </div>
                                            </TableCell>
            ...
            <Dialog open={showDebitNoteDetails} onOpenChange={setShowDebitNoteDetails}>
                <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
                    <DialogHeader>
                        <DialogTitle>
                            Debit Note Details - {selectedDebitNote?.invoice_no}
                        </DialogTitle>
                        <DialogDescription>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <Card>
                                    ...
                                    <CardContent className="space-y-2">
                                        ...
                                        <div className="flex justify-between">
                                            <span>Date:</span>
                                            <span>{format(new Date(selectedDebitNote.invoice_date), 'MMM dd, yyyy')}</span>
                                        </div>
                                        <div className="flex justify-between">
                                            <span>Due Date:</span>
                                ...
                                <Card>
                                    ...
                                    <CardContent className="space-y-2">
                                        <div className="flex justify-between">
                                            <span>Net Total:</span>
                                            <span className="font-medium text-orange-600">{selectedDebitNote.currency} {selectedDebitNote.net_total.toFixed(2)}</span>
                                        </div>
                                        <div className="flex justify-between">
                                            <span>Tax Total:</span>
                                            <span className="font-medium text-orange-600">{selectedDebitNote.currency} {selectedDebitNote.tax_total.toFixed(2)}</span>
                                        </div>
                                        <div className="flex justify-between">
                                            <span>Grand Total:</span>
                                            <span className="font-medium text-orange-600">{selectedDebitNote.currency} {selectedDebitNote.grand_total.toFixed(2)}</span>
                                        </div>
                                        <div className="flex justify-between">
                                            <span>Paid Amount:</span>
                                            <span className="font-medium text-orange-600">{selectedDebitNote.currency} {selectedDebitNote.paid_amount.toFixed(2)}</span>
                                        </div>
                                        <div className="flex justify-between">
                                            <span>Outstanding:</span>
                                            <span className="font-medium text-orange-600">{selectedDebitNote.currency} {selectedDebitNote.outstanding_amount.toFixed(2)}</span>
                                        </div>
                                    </CardContent>
                                </Card>
                            </div>
