...
module.exports = {
    ...
    rules: {
        ...
        "no-restricted-properties": [
            "error",
            {
                ...
                property: "raw",
                message: "Raw hex colors are forbidden. Use semantic token classes like 'bg-brand-solid' instead.",
            },
        ],
    ...
    overrides: [
            ...
            rules: {
                ...
                "no-restricted-syntax": [
                    ...
                    },
                    {
                        ...
                        message: "Hex colors in template literals are forbidden. Use semantic token classes instead.",
                    },
                ],
        ...
        // Prevent raw CSS properties in style objects
        {
            selector: "Property[key.name=/^(backgroundColor|color|borderColor|fill|stroke)$/]",
            message: "Raw color properties are forbidden. Use Tailwind classes with semantic tokens instead.",
        },
      },
    },
  ],
