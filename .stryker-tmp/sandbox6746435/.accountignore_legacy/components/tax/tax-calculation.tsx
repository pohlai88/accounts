    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Manage tax rates, calculations, and compliance</p>
        </div>
          ...
          <Dialog open={showCalculateDialog} onOpenChange={setShowCalculateDialog}>
            ...
            <DialogContent>
              <DialogHeader>
                ...
                <DialogDescription>Calculate tax for a transaction</DialogDescription>
              </DialogHeader>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input
                      ...
                      onChange={e =>
                        setCalculateForm(prev => ({ ...prev, transactionId: e.target.value }))
                      }
                  ...
                  <div>
                    ...
                    <Select
                      ...
                      onValueChange={value =>
                        setCalculateForm(prev => ({ ...prev, transactionType: value as any }))
                      }
                    >
                      <SelectTrigger>
                        <SelectValue />
      ...
      {taxSummary.length > 0 && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>Tax collected and payable for the current year</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="text-center">
                <div className="text-2xl font-bold text-blue-600">
                  {formatCurrency(
                    taxSummary.reduce((sum, item) => sum + item.totalTaxableAmount, 0),
                  )}
                </div>
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <CardDescription>Manage tax rates and categories</CardDescription>
                </div>
                <div className="flex space-x-2">
                  <Dialog
                  ...
                  >
                    ...
                    <DialogContent>
                      <DialogHeader>
                        ...
                        <DialogDescription>Add a new tax category</DialogDescription>
                      </DialogHeader>
                      <div className="space-y-4">
                        <div>
                        ...
                        <div>
                          ...
                          <Input
                            ...
                            onChange={e =>
                              setCategoryForm(prev => ({ ...prev, categoryCode: e.target.value }))
                            }
                            placeholder="e.g., ST"
                          />
                        </div>
                      ...
                      <div className="space-y-4">
                        <div>
                          ...
                          <Input
                            ...
                            onChange={e =>
                              setRateForm(prev => ({ ...prev, rateName: e.target.value }))
                            }
                        ...
                        <div className="grid grid-cols-2 gap-4">
                          <div>
                            ...
                            <Input
                              ...
                              onChange={e =>
                                setRateForm(prev => ({ ...prev, rateCode: e.target.value }))
                              }
                              placeholder="e.g., STD"
                            />
                          </div>
                          <div>
                            ...
                            <Select
                              ...
                              onValueChange={value =>
                                setRateForm(prev => ({ ...prev, taxType: value as any }))
                              }
                            >
                              <SelectTrigger>
                                <SelectValue />
                        ...
                        <div>
                          ...
                          <Select
                            ...
                            onValueChange={value =>
                              setRateForm(prev => ({ ...prev, taxCategoryId: value }))
                            }
                          >
                            <SelectTrigger>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                          ...
                          <div>
                            ...
                            <Input
                              ...
                              onChange={e =>
                                setRateForm(prev => ({ ...prev, effectiveFrom: e.target.value }))
                              }
                            />
                          </div>
                        </div>
                    ...
                    <TableBody>
                      {taxRates.map(rate => (
                        <TableRow key={rate.id}>
                          ...
                          <TableCell>
                            <Badge className={getTaxTypeColor(rate.taxType)}>{rate.taxType}</Badge>
                          </TableCell>
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <CardDescription>Group multiple tax rates together</CardDescription>
                </div>
                <Dialog open={showCreateGroupDialog} onOpenChange={setShowCreateGroupDialog}>
                  ...
                  <DialogContent>
                    <DialogHeader>
                      ...
                      <DialogDescription>Create a group of tax rates</DialogDescription>
                    </DialogHeader>
                    <div className="space-y-4">
                      <div>
                      ...
                      <div>
                        ...
                        <Input
                          ...
                          onChange={e =>
                            setGroupForm(prev => ({ ...prev, groupCode: e.target.value }))
                          }
        ...
        <TabsContent value="calculations" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>View and manage tax calculations</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="text-center py-8">
                <Calculator className="h-12 w-12 text-muted-foreground mx-auto mb-4" />
        ...
        <TabsContent value="returns" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Manage tax returns and filings</CardDescription>
            </CardHeader>
            <CardContent>
              {taxReturns.length > 0 ? (
                <div className="border rounded-lg">
                    ...
                    <TableBody>
                      {taxReturns.map(returnItem => (
                        <TableRow key={returnItem.id}>
                          ...
                          <TableCell>
                            {format(new Date(returnItem.taxPeriodStart), "MMM dd")} -{" "}
                            {format(new Date(returnItem.taxPeriodEnd), "MMM dd, yyyy")}
                          </TableCell>
                          <TableCell>
