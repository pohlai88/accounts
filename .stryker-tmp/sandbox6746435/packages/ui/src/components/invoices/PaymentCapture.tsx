                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center space-x-2 mb-1">
                        <span className="font-medium text-sys-text-primary">{method.label}</span>
                        <span
                          className={cn(
                      ...
                      <div className="text-sm text-sys-text-secondary">
                        ...
                        {payment.processedAt && (
                          <span className="ml-2">Processed: {formatDate(payment.processedAt)}</span>
                        )}
                      </div>

                      {payment.notes && (
                        <div className="text-sm text-sys-text-tertiary mt-1">{payment.notes}</div>
                      )}
                    </div>
                  </div>
