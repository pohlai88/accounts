            ...
            >
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  {member.company && <p className="text-xs text-gray-400">{member.company.name}</p>}
                </div>
              </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span
                    className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${roleColors[member.role as keyof typeof roleColors]}`}
                  >
                    {member.role}
                  </span>
                </div>
