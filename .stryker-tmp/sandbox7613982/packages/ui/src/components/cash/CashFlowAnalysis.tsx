...
const mockForecastData: ForecastData[] = [
  {
    date: "2024-01-11",
    predictedInflow: 4000.0,
    predictedOutflow: 1200.0,
    predictedNetFlow: 2800.0,
    predictedBalance: 3848.0,
    confidence: 0.85,
    scenario: "realistic",
  },
  {
    date: "2024-01-12",
    predictedInflow: 0.0,
    predictedOutflow: 800.0,
    predictedNetFlow: -800.0,
    predictedBalance: 3048.0,
    confidence: 0.9,
    scenario: "realistic",
  },
  {
    date: "2024-01-13",
    predictedInflow: 0.0,
    predictedOutflow: 600.0,
    predictedNetFlow: -600.0,
    predictedBalance: 2448.0,
    confidence: 0.88,
    scenario: "realistic",
  },
  {
    date: "2024-01-14",
    predictedInflow: 0.0,
    predictedOutflow: 8500.0,
    predictedNetFlow: -8500.0,
    predictedBalance: -6052.0,
    confidence: 0.95,
    scenario: "realistic",
  },
  {
    date: "2024-01-15",
    predictedInflow: 6000.0,
    predictedOutflow: 0.0,
    predictedNetFlow: 6000.0,
    predictedBalance: -52.0,
    confidence: 0.8,
    scenario: "realistic",
  },
];
...
export function CashFlowAnalysis({
  ...
  const getScenarioColor = (scenario: string) => {
    switch (scenario) {
      ...
      case "realistic":
        return "bg-sys-blue-100 text-sys-blue-800 border-sys-blue-200";
      case "pessimistic":
    ...
    <div className={cn("space-y-6", className)}>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-6">
                    ...
                    <div className="text-right">
                      ...
                      <p className="font-medium text-sys-red-600">{formatCurrency(item.outflow)}</p>
                    </div>
                    ...
                    <div className="flex items-center gap-4">
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-sys-fg-muted">{selectedScenario} scenario</p>
                        </div>
                      </div>

                      <Badge className={getScenarioColor(item.scenario)}>{item.scenario}</Badge>
                    </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>AI-generated insights based on your cash flow patterns.</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
            <Alert className="border-sys-green-200">
              ...
              <AlertDescription>
                <strong>Positive Trend:</strong> Your cash flow has improved by 12.5% over the last
                30 days. Consider increasing your cash reserves to maintain this momentum.
              </AlertDescription>
            </Alert>
            ...
            <Alert className="border-sys-yellow-200">
              ...
              <AlertDescription>
                <strong>Volatility Alert:</strong> Your cash flow shows 8.2% volatility. Consider
                smoothing out irregular payments to improve predictability.
              </AlertDescription>
            </Alert>
            ...
            <Alert className="border-sys-blue-200">
              ...
              <AlertDescription>
                <strong>Forecast Insight:</strong> Based on current trends, you have 220 days of
                cash runway. This provides good buffer for business operations and growth
                investments.
              </AlertDescription>
            </Alert>
          </div>
