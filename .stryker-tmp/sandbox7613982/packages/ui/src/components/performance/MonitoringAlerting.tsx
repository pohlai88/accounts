    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-3">
          <Button onClick={onCreateAlertRule} className="flex items-center space-x-2">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Card className="p-4">
          <CardContent className="p-0">
            ...
            <div className="text-xs text-[var(--sys-text-tertiary)]">{alertRules.length} total</div>
          </CardContent>
        </Card>
        ...
        <Card className="p-4">
          <CardContent className="p-0">
            ...
            <div className="text-xs text-[var(--sys-text-tertiary)]">Monitored</div>
          </CardContent>
        </Card>
      </div>
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex-1">
                    ...
                    <h4 className="font-medium text-[var(--sys-text-primary)] mb-1">{rule.name}</h4>
                    <p className="text-sm text-[var(--sys-text-secondary)] mb-2">
                      {rule.description}
                    </p>
                    <div className="text-xs text-[var(--sys-text-tertiary)]">
                      {rule.metric} {rule.condition.replace("_", " ")} {rule.threshold} | Triggered{" "}
                      {rule.triggerCount} times | Channels: {rule.channels.join(", ")}
                      {rule.lastTriggered &&
                        ` | Last triggered: ${rule.lastTriggered.toLocaleString()}`}
                    </div>
                  </div>
                  <div className="flex items-center space-x-2 ml-4">
                    <Button size="sm" variant="outline" onClick={() => onUpdateAlertRule(rule.id)}>
