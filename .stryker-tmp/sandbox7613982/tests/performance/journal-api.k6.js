...
export default function (data) {
  ...
  const createResponse = http.post(`${BASE_URL}/api/journals`, JSON.stringify(journalPayload), {
    headers,
  });
  ...
  const searchResponse = http.get(`${BASE_URL}/api/journals/search?q=Performance Test&limit=10`, {
    headers,
  });
