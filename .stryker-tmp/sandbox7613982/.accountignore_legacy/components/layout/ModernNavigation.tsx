    ...
    // Advanced Features
    {
      ...
      children: [
        ...
        { id: "monitoring", label: "Continuous Monitoring", icon: Shield, href: "/monitoring" },
        {
          ...
          label: "Treasury Optimization",
          icon: PiggyBank,
          href: "/treasury-optimization",
        },
            ...
            {!collapsed && (
              <div className="flex items-center space-x-2">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 dark:text-gray-400">Next-Gen Accounting</p>
                </div>
              </div>
            )}
                ...
                {quickActions.slice(0, 4).map(action => (
                  <Tooltip key={action.id}>
                    ...
                    <TooltipContent side="bottom">
                      <p>
                        {action.label}{" "}
                        {action.shortcut && <kbd className="ml-1">{action.shortcut}</kbd>}
                      </p>
                    </TooltipContent>
                  </Tooltip>
                ))}
      ...
      <Tooltip>
        ...
        <TooltipContent side="right">
          <div className="flex items-center gap-2">
            ...
            {item.badge && (
              <Badge className={item.badgeColor || "bg-blue-100 text-blue-800"}>{item.badge}</Badge>
            )}
          </div>
        </TooltipContent>
      </Tooltip>
