            ...
            <CardContent className="space-y-3">
              {filteredVersions.map(version => (
                ...
                >
                  ...
                  <p className="text-xs text-[var(--sys-text-tertiary)] mb-2">
                    {version.changeLog}
                  </p>
            ...
            <div className="space-y-6">
              ...
              <Card>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-2">
                      {!selectedVersion.isActive && (
                        <Button size="sm" onClick={() => handleActivateVersion(selectedVersion.id)}>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div>
                    <h5 className="text-sm font-medium text-[var(--sys-text-primary)] mb-2">
                      Change Log
                    </h5>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-[var(--sys-text-secondary)]">
                        {selectedVersion.executionCount}
                      </div>
                    </div>
                    <div>
                      <div className="text-sm font-medium text-[var(--sys-text-primary)]">
                ...
                <CardContent className="space-y-4">
                  <div className="flex items-center space-x-3">
                    <select
                      ...
                      onChange={e =>
                        setCompareVersion(versions.find(v => v.id === e.target.value) || null)
                      }
                    ...
                    >
                      ...
                      {versions
                        .filter(
                          v => v.ruleId === selectedVersion.ruleId && v.id !== selectedVersion.id,
                        )
                        .map(version => (
                  ...
                  {versionDiffs.length > 0 && (
                    <div className="space-y-3">
                      <h5 className="text-sm font-medium text-[var(--sys-text-primary)]">
                        Differences
                      </h5>
                      {versionDiffs.map((diff, index) => (
                        <div
                          key={index}
                          className="p-3 border border-[var(--sys-border-hairline)] rounded-lg"
                        >
                          ...
                          <div className="grid grid-cols-2 gap-4 text-sm">
                            <div>
                              <div className="text-[var(--sys-text-secondary)] mb-1">
                                Old Value:
                              </div>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="flex flex-wrap gap-3">
                    <Button variant="outline" onClick={() => onExportVersion(selectedVersion.id)}>
                    ...
                    <Button
                      variant="outline"
                      onClick={() =>
                        onTagVersion(selectedVersion.id, [...selectedVersion.tags, "new-tag"])
                      }
                    >
            ...
            <Card>
              <CardContent className="flex flex-col items-center justify-center py-12">
                ...
                <p className="text-[var(--sys-text-secondary)] text-center">
                  Select a version from the list to view its details and compare with other
                  versions.
                </p>
              </CardContent>
            </Card>
