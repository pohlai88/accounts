  ...
  refresh: function (frm) {
    if (!frm.doc.__islocal) {
      frm.add_custom_button(__("Send Emails"), function () {
        ...
        frappe.call({
          method:
            "erpnext.accounts.doctype.process_statement_of_accounts.process_statement_of_accounts.send_emails",
          args: {
...
frappe.ui.form.on("Process Statement Of Accounts Customer", {
  customer: function (frm, cdt, cdn) {
    ...
    frappe.call({
      method:
        "erpnext.accounts.doctype.process_statement_of_accounts.process_statement_of_accounts.get_customer_emails",
      args: {
