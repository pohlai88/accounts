      ...
      {conflicts.length > 0 && (
        <Alert variant="default">
          ...
          <div>
            ...
            <p className="text-sm">
              {conflicts.length} conflicts need resolution. Review each conflict and choose how to
              resolve them.
            </p>
          </div>
        </Alert>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <Card className="p-4">
          <CardContent className="p-0">
            ...
            <div className="text-xs text-[var(--sys-text-tertiary)]">Need resolution</div>
          </CardContent>
        </Card>
        ...
        <Card className="p-4">
          <CardContent className="p-0">
            ...
            <div className="text-xs text-[var(--sys-text-tertiary)]">Ready to resolve</div>
          </CardContent>
        </Card>
        ...
        <Card className="p-4">
          <CardContent className="p-0">
            ...
            <div className="text-xs text-[var(--sys-text-tertiary)]">Pending sync</div>
          </CardContent>
        </Card>
        ...
        <Card className="p-4">
          <CardContent className="p-0">
            ...
            <div className="text-xs text-[var(--sys-text-tertiary)]">Most common</div>
          </CardContent>
        </Card>
      </div>
                        ...
                        <div className="flex items-center space-x-2 mb-2">
                          ...
                          <div
                            className={cn(
                              ...
                              getConflictTypeColor(conflict.conflictType),
                            )}
                          >
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                          <div className="p-3 bg-[var(--sys-fill-low)] rounded-lg">
                            <div className="flex items-center space-x-2 mb-2">
                              ...
                              <span className="text-xs font-medium text-[var(--sys-text-secondary)]">
                                Local Version
                              </span>
                            </div>
              ...
              <div className="space-y-3">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-[var(--sys-text-secondary)]">
                      Examine both versions before deciding
                    </p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-[var(--sys-text-secondary)]">
                      Think about which version is more recent/accurate
                    </p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-[var(--sys-text-secondary)]">
                      Add reasons for your resolution choices
                    </p>
                  </div>
                </div>
              </div>
