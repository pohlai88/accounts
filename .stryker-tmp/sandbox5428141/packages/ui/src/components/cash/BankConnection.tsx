...
export function BankConnection({
  ...
  const [connectionStep, setConnectionStep] = useState<
    "select" | "authenticate" | "verify" | "complete"
  >("select");
    ...
    <div className={cn("space-y-6", className)}>
                    ...
                    <div className="flex items-center gap-3 mb-3">
                      ...
                      <div>
                        ...
                        <Badge
                          ...
                          className={cn(
                            "text-xs",
                            provider.securityLevel === "high" &&
                              "border-sys-green-200 text-sys-green-700",
                            provider.securityLevel === "medium" &&
                              "border-sys-yellow-200 text-sys-yellow-700",
                            provider.securityLevel === "low" &&
                              "border-sys-red-200 text-sys-red-700",
                          )}
                        >
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <Alert>
              ...
              <AlertDescription>
                Your bank credentials are never stored. We use bank-level security to connect your
                accounts.
              </AlertDescription>
            </Alert>
      ...
      {connectionStep === "complete" && (
        <Alert>
          ...
          <AlertDescription>
            Bank account connected successfully! You can now import transactions and reconcile your
            accounts.
          </AlertDescription>
        </Alert>
      )}
