...
[AI-BOS Accounts API Documentation (Source)](../../../README.md) / [@aibos/tokens](../README.md) / SEMANTIC\_TOKENS

# Variable: SEMANTIC\_TOKENS

> `const` **SEMANTIC\_TOKENS**: `object`

Defined in: [tokens.ts:100](https://github.com/pohlai88/accounts/blob/40016c553531e31c50d7dcad114ff9c2ce691261/packages/tokens/src/tokens.ts#L100)
...
> `readonly` **secondary**: `"transparent"` = `"transparent"`
