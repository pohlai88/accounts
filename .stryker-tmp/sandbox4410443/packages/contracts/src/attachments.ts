...
// Attachment Status
export const AttachmentStatus = z.enum(["active", "archived", "deleted", "processing", "failed"]);
...
export const ListAttachmentsReq = z.object({
  ...
  // Sorting
  sortBy: z
    .enum(["created_at", "updated_at", "filename", "file_size", "category"])
    .optional()
    .default("created_at"),
...
export const DocumentApprovalReq = z.object({
  ...
  // Approval workflow
  workflowType: z
    .enum(["single_approver", "multi_stage", "parallel_approval"])
    .optional()
