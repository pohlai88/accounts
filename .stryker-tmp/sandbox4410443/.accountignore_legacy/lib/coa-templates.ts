...
export const COA_TEMPLATES: CoATemplate[] = [
...

  {
    ...
    accounts: [
      ...
      {
        name: "Merchant Account Receivable",
        account_type: "Asset",
        account_code: "1125",
        parent_code: "1100",
        is_group: false,
      ...
      {
        name: "Accumulated Depreciation - POS",
        account_type: "Asset",
        account_code: "1525",
        parent_code: "1500",
        is_group: false,
      ...
      {
        name: "Credit Card Processing Fees Payable",
        account_type: "Liability",
        account_code: "2150",
        parent_code: "2100",
        is_group: false,
...

  {
    ...
    accounts: [
      ...
      {
        name: "Accumulated Depreciation - Office Furniture",
        account_type: "Asset",
        account_code: "1525",
        parent_code: "1500",
        is_group: false,
...

  {
    ...
    accounts: [
      ...
      {
        name: "Manufacturing Overhead Payable",
        account_type: "Liability",
        account_code: "2130",
        parent_code: "2100",
        is_group: false,
...

  {
    ...
    accounts: [
      ...
      {
        name: "Prepaid Professional Insurance",
        account_type: "Asset",
        account_code: "1300",
        parent_code: "1100",
        is_group: false,
      ...
      {
        name: "Professional Liability Insurance Payable",
        account_type: "Liability",
        account_code: "2120",
        parent_code: "2100",
        is_group: false,
      ...
      {
        name: "Professional Staff Salaries",
        account_type: "Expense",
        account_code: "5220",
        parent_code: "5200",
        is_group: false,
