        ...
        <TabsContent value="hierarchy" className="space-y-4">
          <div className="flex items-center space-x-4">
            ...
            <Select
              ...
              onValueChange={(value: TagType) => setSelectedTagType(value)}
            >
          ...
          <Card>
            ...
            <CardContent>
              {hierarchy.length > 0 ? (
                <div className="space-y-2">{renderTagHierarchy(hierarchy)}</div>
              ) : (
                <div className="text-center py-8 text-muted-foreground">
                  <Tag className="h-12 w-12 mx-auto mb-4 opacity-50" />
                  <p>No {selectedTagType.toLowerCase()}s found</p>
                  <p className="text-sm">
                    Create your first {selectedTagType.toLowerCase()} to get started
                  </p>
                </div>
              )}
            </CardContent>
            ...
            <CardContent>
              {reports.length > 0 ? (
                  ...
                  {reports.map(report => (
                    ...
                    >
                      ...
                      <div className="text-right">
                        <p className="font-bold">${Math.abs(report.net_amount).toLocaleString()}</p>
                        <p className="text-sm text-muted-foreground">
                ...
                <div className="text-center py-8 text-muted-foreground">
                  ...
                  <p className="text-sm">
                    Create transactions with {selectedTagType.toLowerCase()} assignments
                  </p>
                </div>
              )}
            </CardContent>
        ...
        <TabsContent value="settings" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Configure tag tracking preferences and defaults</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                <div>
