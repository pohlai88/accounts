...
export const ValidationI18nProvider: React.FC<{
  ...
  return (
    <ValidationI18nContext.Provider value={mergedI18n}>{children}</ValidationI18nContext.Provider>
  );
};
...
export const useValidationTranslations = () => {
  ...
  const getCategoryLabel = (category: string): string => {
    switch (category) {
      case "business_rule":
        return i18n.businessRule;
      case "data_integrity":
        return i18n.dataIntegrity;
      case "compliance":
  ...
  const getImpactLabel = (impact: string): string => {
    switch (impact) {
      case "high":
        return i18n.highImpact;
      case "medium":
        return i18n.mediumImpact;
      case "low":
        return i18n.lowImpact;
      default:
        return impact;
    }
  };
