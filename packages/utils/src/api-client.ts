...
export class ApiClient {
    ...
    async request<T>(
        ...
        try {
            ...
            return this.createSuccessResponse(responseData, context);
    ...
    async get<T>(endpoint: string, options?: Omit<Parameters<typeof this.request>[1], 'method' | 'body'>) {
        return this.request<T>(endpoint, { ...options, method: 'GET' });
    }

    async post<T>(endpoint: string, body?: unknown, options?: Omit<Parameters<typeof this.request>[1], 'method' | 'body'>) {
        return this.request<T>(endpoint, { ...options, method: 'POST', body });
    }

    async put<T>(endpoint: string, body?: unknown, options?: Omit<Parameters<typeof this.request>[1], 'method' | 'body'>) {
        return this.request<T>(endpoint, { ...options, method: 'PUT', body });
    }

    async patch<T>(endpoint: string, body?: unknown, options?: Omit<Parameters<typeof this.request>[1], 'method' | 'body'>) {
        return this.request<T>(endpoint, { ...options, method: 'PATCH', body });
    }

    async delete<T>(endpoint: string, options?: Omit<Parameters<typeof this.request>[1], 'method' | 'body'>) {
