...
import { ExportFormat, ExportOptions, ExportResult, ExportableData, ReportExportRequest } from './types';
 ...
 */
async function generateReportDataFromRequest(request: ReportExportRequest): Promise<ExportableData> {
  ...
  switch (request.reportType) {
    ...
    case 'balance-sheet':
      return {
        ...
        metadata: { ...baseMetadata, totalAssets: 75000, totalLiabilities: 25000, totalEquity: 50000 }
      };
    ...
    case 'cash-flow':
      return {
        ...
        metadata: { ...baseMetadata, netOperatingCash: 18000, netInvestingCash: -10000, netFinancingCash: 5000, netCashChange: 13000 }
      };
