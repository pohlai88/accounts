  ...
  describe("Type Definitions", () => {
    it("should have correct audit action types", () => {
      ...
      const actions = [
        ...
        'APPROVE', 'REJECT', 'SUBMIT', 'CANCEL', 'VALIDATE',
        'EXPORT', 'IMPORT', 'HIT', 'EXPIRE'
      ];
    ...
    it("should have correct entity types", () => {
      const entities = [
        'JOURNAL', 'JOURNAL_LINE', 'INVOICE', 'PAYMENT', 'ACCOUNT',
        'TENANT', 'COMPANY', 'USER', 'MEMBERSHIP', 'CURRENCY', 
        'FX_RATE', 'IDEMPOTENCY_KEY'
      ];
