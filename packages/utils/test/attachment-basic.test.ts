...
import { attachmentService, AttachmentService } from "@aibos/utils/storage/attachment-service";
...
describe("Attachment Service - Basic Tests", () => {
  ...
  describe("Download File", () => {
    it("should download file successfully", async () => {
      ...
      // Act
      const result = await mockAttachmentService.downloadFile(
        "attachment-123",
        "tenant-123",
        "user-789",
      );
  ...
  describe("Delete Attachment", () => {
    it("should delete attachment successfully", async () => {
      ...
      // Act
      const result = await mockAttachmentService.deleteAttachment(
        "attachment-123",
        "tenant-123",
        "user-789",
      );
  ...
  describe("Get Entity Attachments", () => {
    it("should retrieve entity attachments successfully", async () => {
      ...
      // Act
      const result = await mockAttachmentService.getEntityAttachments(
        "invoice",
        "invoice-456",
        "tenant-123",
      );
