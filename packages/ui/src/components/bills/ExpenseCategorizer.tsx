...
export const ExpenseCategorizer: React.FC<ExpenseCategorizerProps> = ({
    ...
    const mockRules: CategorizationRule[] = [
        ...
        },
        {
            ...
            conditions: [
                { field: 'vendor', operator: 'contains', value: 'Office Depot' }
            ],
            categoryId: '1',
            priority: 2,
            isActive: true,
        ...
        <div className={cn('space-y-6', className)}>
                ...
                <div className="flex space-x-2">
                    <button
                        ...
                        className={cn(
                            ...
                            activeTab === 'categories' && 'btn-primary'
                        )}
                ...
                <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        {categories.map((category) => (
                            <div key={category.id} className="bg-sys-bg-raised border border-sys-border-hairline rounded-lg p-4">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="flex justify-between text-xs">
                                        ...
                                        <span className={cn(
                                            'text-xs',
                                            category.taxDeductible ? 'text-sys-status-success' : 'text-sys-text-tertiary'
                                        )}>
            ...
            {activeTab === 'rules' && (
                <div className="space-y-6">
                    ...
                    <div className="space-y-4">
                        {rules.map((rule) => (
                            <div key={rule.id} className="bg-sys-bg-raised border border-sys-border-hairline rounded-lg p-4">
                                <div className="flex items-center justify-between mb-3">
                                    <div className="flex items-center space-x-3">
                                        <div className="p-2 bg-sys-status-info/10 rounded-lg">
            ...
            {showCategoryForm && (
                <div className="bg-sys-bg-raised border border-sys-border-hairline rounded-lg p-6">
                    ...
                    <div className="space-y-4">
                        <div>
                            <label htmlFor="category-name" className="block text-sm font-medium text-sys-text-primary mb-2">
                                Category Name
                            </label>
                            <input
                                id="category-name"
                        ...
                        <div>
                            <label htmlFor="category-description" className="block text-sm font-medium text-sys-text-primary mb-2">
                                Description
                            </label>
                            <textarea
                        ...
                        <div>
                            <label htmlFor="category-account" className="block text-sm font-medium text-sys-text-primary mb-2">
                                Account
                            </label>
                            <input
                                id="category-account"
                        ...
                        <div className="flex justify-end space-x-3">
                            ...
                            <button
                                onClick={() => {
                                    ...
                                    const account = (document.getElementById('category-account') as HTMLInputElement)?.value;
                                    const taxDeductible = (document.getElementById('tax-deductible') as HTMLInputElement)?.checked;

                                    if (editingCategory) {
                                        handleCategoryUpdate(editingCategory.id, { name, description, account, taxDeductible });
                                    } else {
            ...
            {showRuleForm && (
                <div className="bg-sys-bg-raised border border-sys-border-hairline rounded-lg p-6">
                    ...
                    <div className="space-y-4">
                        <div>
                            <label htmlFor="rule-name" className="block text-sm font-medium text-sys-text-primary mb-2">
                                Rule Name
                            </label>
                            <input
                                id="rule-name"
                        ...
                        <div>
                            <label htmlFor="rule-description" className="block text-sm font-medium text-sys-text-primary mb-2">
                                Description
                            </label>
                            <textarea
                                id="rule-description"
                        ...
                        <div>
                            <label htmlFor="rule-category" className="block text-sm font-medium text-sys-text-primary mb-2">
                                Category
                            </label>
                            <select
                                id="rule-category"
                        ...
                        <div>
                            <label htmlFor="rule-priority" className="block text-sm font-medium text-sys-text-primary mb-2">
                                Priority
                            </label>
                            <input
                                id="rule-priority"
                        ...
                        <div className="flex justify-end space-x-3">
                            ...
                            <button
                                onClick={() => {
                                    ...
                                    const categoryId = (document.getElementById('rule-category') as HTMLSelectElement)?.value;
