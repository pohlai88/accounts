...
import { Plus, Search, Edit, Trash2, User, Mail, Phone, MapPin, Building, Star, MoreHorizontal } from 'lucide-react';
            ...
            <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-sys-text-tertiary">Manage your vendor relationships and information</p>
                    </div>
                </div>
                <button
            ...
            <div className="bg-sys-bg-raised border border-sys-border-hairline rounded-lg p-6">
                            ...
                            <div className="flex items-center space-x-4">
                                ...
                                <div className="flex-1 min-w-0">
                                    <div className="flex items-center space-x-2 mb-1">
                                        ...
                                        {vendor.isPreferred && (
                                            <Star className="h-4 w-4 text-sys-status-warning fill-current" aria-hidden="true" />
                                        )}
                                    </div>
                ...
                {filteredVendors.length === 0 && (
                    <div className="text-center py-8">
                        <Building className="h-12 w-12 text-sys-text-tertiary mx-auto mb-4" aria-hidden="true" />
            ...
            {selectedVendor && (
                <div className="bg-sys-bg-raised border border-sys-border-hairline rounded-lg p-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="space-y-4">
                            <div>
                                <h4 className="text-sm font-medium text-sys-text-primary mb-2">Contact Information</h4>
                                <div className="space-y-2">
                                    ...
                                    {selectedVendor.phone && (
                                        <div className="flex items-center space-x-2">
                                            ...
                                            <span className="text-sm text-sys-text-secondary">{selectedVendor.phone}</span>
                                        </div>
                                    )}
                                    {selectedVendor.website && (
                                        <div className="flex items-center space-x-2">
                                            <span className="text-sm text-sys-text-secondary">{selectedVendor.website}</span>
                                        </div>
                                    )}
                                </div>
                            </div>
                                    ...
                                    <div className="flex items-start space-x-2">
                                        ...
                                        <div className="text-sm text-sys-text-secondary">
                                            ...
                                            {selectedVendor.address.city && selectedVendor.address.state && (
                                                <div>{selectedVendor.address.city}, {selectedVendor.address.state} {selectedVendor.address.zipCode}</div>
                                            )}
                                            {selectedVendor.address.country && <div>{selectedVendor.address.country}</div>}
                                        </div>
                                    </div>
                                </div>
                            )}
                        ...
                        <div className="space-y-4">
                            <div>
                                <h4 className="text-sm font-medium text-sys-text-primary mb-2">Business Information</h4>
                                <div className="space-y-2">
                                    <div>
                                        <span className="text-xs text-sys-text-tertiary">Tax ID</span>
                                        <p className="text-sm text-sys-text-secondary">{selectedVendor.taxId || 'Not provided'}</p>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-sys-text-secondary">{selectedVendor.defaultCategory}</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div className="space-y-2">
                                    <div>
                                        ...
                                        <p className="text-sm font-medium text-sys-text-primary">${selectedVendor.totalSpent.toFixed(2)}</p>
                                    </div>
                                    <div>
