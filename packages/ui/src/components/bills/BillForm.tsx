...
import { Plus, Minus, Trash2, Calendar, User, DollarSign, FileText, Upload, Paperclip } from 'lucide-react';
        ...
        <form onSubmit={handleSubmit} className={cn('space-y-6', className)}>
            ...
            <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-sys-text-tertiary">Enter bill details and attach supporting documents</p>
                    </div>
                </div>
            ...
            <div className="bg-sys-bg-raised border border-sys-border-hairline rounded-lg p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        <label htmlFor="vendor-search" className="block text-sm font-medium text-sys-text-primary mb-2">
                            Vendor
                        </label>
                        <div className="relative">
                            ...
                            />
                            <User className="absolute left-3 top-1/2 transform -translate-y-1/2 h-4 w-4 text-sys-text-tertiary" aria-hidden="true" />
                        </div>
                    ...
                    <div>
                        <label htmlFor="bill-number" className="block text-sm font-medium text-sys-text-primary mb-2">
                            Bill Number
                        </label>
                        <input
                            id="bill-number"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                    <div>
                        <label htmlFor="bill-date" className="block text-sm font-medium text-sys-text-primary mb-2">
                            Bill Date
                        </label>
                        <div className="relative">
                            <input
                            ...
                            />
                            <Calendar className="absolute left-3 top-1/2 transform -translate-y-1/2 h-4 w-4 text-sys-text-tertiary" aria-hidden="true" />
                        </div>
                    </div>

                    <div>
                        <label htmlFor="due-date" className="block text-sm font-medium text-sys-text-primary mb-2">
                            Due Date
                        </label>
                        <div className="relative">
                            <input
                    ...
                    {formData.items.map((item, index) => (
                        <div key={item.id} className="grid grid-cols-12 gap-4 items-end">
                            <div className="col-span-5">
                                <label htmlFor={`item-description-${item.id}`} className="block text-sm font-medium text-sys-text-primary mb-2">
                                    Description
                                </label>
                                <input
                            ...
                            <div className="col-span-2">
                                <label htmlFor={`item-quantity-${item.id}`} className="block text-sm font-medium text-sys-text-primary mb-2">
                                    Qty
                                </label>
                                <input
                            ...
                            <div className="col-span-2">
                                <label htmlFor={`item-price-${item.id}`} className="block text-sm font-medium text-sys-text-primary mb-2">
                                    Unit Price
                                </label>
                                <input
                            ...
                            <div className="col-span-2">
                                <label htmlFor={`item-total-${item.id}`} className="block text-sm font-medium text-sys-text-primary mb-2">
                                    Total
                                </label>
                                <input
            ...
            <div className="bg-sys-bg-raised border border-sys-border-hairline rounded-lg p-6">
                ...
                <div className="space-y-4">
                    <div className="border-2 border-dashed border-sys-border-subtle rounded-lg p-6 text-center">
                        ...
                        <p className="text-sm text-sys-text-secondary mb-2">Drop files here or click to upload</p>
                        <input
                            type="file"
                            multiple
                    ...
                    {formData.attachments.length > 0 && (
                        <div className="space-y-2">
                            {formData.attachments.map((attachment) => (
                                <div key={attachment.id} className="flex items-center justify-between p-3 bg-sys-fill-low rounded-lg">
                                    <div className="flex items-center space-x-3">
