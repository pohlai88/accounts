...
import { CreditCard, Banknote, Calendar, Clock, CheckCircle, AlertCircle, DollarSign, Send } from 'lucide-react';
            ...
            <div className="bg-sys-bg-raised border border-sys-border-hairline rounded-lg p-6">
                ...
                <div className="space-y-4">
                    <div>
                        ...
                        <p className="text-xs text-sys-text-tertiary mt-1">
                    ...
                    <div className="border border-sys-border-hairline rounded-lg p-4">
                        ...
                        {isScheduled && (
                            <div className="space-y-4 pt-4 border-t border-sys-border-hairline">
                                <div>
                                    <label htmlFor="scheduled-date" className="block text-sm font-medium text-sys-text-primary mb-2">
                                        Scheduled Date
                                    </label>
                                    <div className="relative">
                                        <input
            ...
            <div className="bg-sys-bg-raised border border-sys-border-hairline rounded-lg p-6">
                ...
                <div className="space-y-3">
                    ...
                    <div className="flex justify-between">
                        ...
                        <span className="text-sm font-medium text-sys-text-primary">${paymentAmount.toFixed(2)}</span>
                    </div>
                    <div className="flex justify-between">
