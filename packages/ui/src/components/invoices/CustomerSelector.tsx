                    ...
                    {!showCreateForm ? (
                        <>
                            ...
                            {filteredCustomers.length > 0 ? (
                                            ...
                                            <div className="flex items-center space-x-3">
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    ...
                                                    <div className="flex items-center space-x-4 mt-1">
                                                        ...
                                                        {customer.phone && (
                                                            <div className="flex items-center space-x-1">
                                                                <Phone className="h-3 w-3 text-sys-text-tertiary" aria-hidden="true" />
                                                    ...
                                                    {customer.address && (
                                                        <div className="flex items-center space-x-1 mt-1">
                                                            <MapPin className="h-3 w-3 text-sys-text-tertiary" aria-hidden="true" />
                                ...
                                <div className="p-4 text-center">
                                    <User className="h-8 w-8 text-sys-text-tertiary mx-auto mb-2" aria-hidden="true" />
                        ...
                        <div className="p-4">
                            ...
                            <div className="space-y-4">
                                <div>
                                    <label htmlFor="new-customer-name" className="block text-sm font-medium text-sys-text-primary mb-2">
                                        Company Name *
                                    </label>
                                    <input
                                ...
                                <div>
                                    <label htmlFor="new-customer-email" className="block text-sm font-medium text-sys-text-primary mb-2">
                                        Email Address *
                                    </label>
                                    <input
                                ...
                                <div>
                                    <label htmlFor="new-customer-phone" className="block text-sm font-medium text-sys-text-primary mb-2">
                                        Phone Number
                                    </label>
                                    <input
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        <label htmlFor="new-customer-city" className="block text-sm font-medium text-sys-text-primary mb-2">
                                            City
                                        </label>
                                        <input
                                    ...
                                    <div>
                                        <label htmlFor="new-customer-state" className="block text-sm font-medium text-sys-text-primary mb-2">
                                            State
                                        </label>
                                        <input
