        ...
        <div className={cn('space-y-6', className)}>
            ...
            <div className="bg-sys-bg-raised border border-sys-border-hairline rounded-lg p-6">
                ...
                {selectedMethod === 'email' && (
                    <div className="space-y-4">
                        <div>
                            <label htmlFor="email-subject" className="block text-sm font-medium text-sys-text-primary mb-2">
                                Email Subject
                            </label>
                            <input
                                id="email-subject"
                        ...
                        <div>
                            <label htmlFor="email-message" className="block text-sm font-medium text-sys-text-primary mb-2">
                                Email Message
                            </label>
                            <textarea
                                id="email-message"
                ...
                {selectedMethod === 'whatsapp' && (
                    <div className="space-y-4">
                        <div>
                            <label htmlFor="whatsapp-message" className="block text-sm font-medium text-sys-text-primary mb-2">
                                WhatsApp Message
                            </label>
                            <textarea
                                id="whatsapp-message"
                ...
                {selectedMethod === 'link' && (
                    <div className="space-y-4">
                        <div>
                            <label htmlFor="share-link" className="block text-sm font-medium text-sys-text-primary mb-2">
                                Shareable Link
                            </label>
                                    ...
                                    <div className="text-right">
                                        <div className="flex items-center space-x-2">
                                            <div className={cn(
                                                ...
                                                item.status === 'sent' ? 'bg-sys-status-info' :
                                                    item.status === 'delivered' ? 'bg-sys-status-success' :
                                                        'bg-sys-status-error'
                                            )}></div>
