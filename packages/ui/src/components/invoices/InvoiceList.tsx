    ...
    if (isLoading) {
        return (
            <div className={cn('space-y-4', className)}>
                {[...Array(5)].map((_, i) => (
                    <div key={i} className="bg-sys-bg-raised border border-sys-border-hairline rounded-lg p-6 animate-pulse">
            ...
            <div className="space-y-2">
                {filteredInvoices.length === 0 ? (
                    <div className="bg-sys-bg-raised border border-sys-border-hairline rounded-lg p-12 text-center">
                        <FileText className="h-12 w-12 text-sys-text-tertiary mx-auto mb-4" aria-hidden="true" />
                                        ...
                                        <div className="flex items-center space-x-4">
                                            ...
                                            <div className="flex items-center space-x-3">
                                                <div className="flex flex-col">
                                                    <span className="font-medium text-sys-text-primary">{invoice.number}</span>
                                                    <span className="text-sm text-sys-text-secondary">{invoice.customerName}</span>
                                                </div>
                                            </div>
                                        </div>
