...
export const PaymentReminders: React.FC<PaymentRemindersProps> = ({
  ...
  useEffect(() => {
    ...
    const processedSubject = template.subject.replace("{invoiceNumber}", invoiceNumber);
          ...
          <div className="space-y-4">
                ...
                {Object.entries(reminderTypes).map(([type, config]) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <p className="text-xs text-sys-text-secondary">{config.description}</p>
                    </button>
                  );
                })}
              </div>
            ...
            <div>
              ...
              <input
                ...
                className="input w-full"
                placeholder={
                  selectedType === "email" ? "customer@example.com" : "+1 (555) 123-4567"
                }
                ...
                >
                  <div className="flex items-center space-x-4">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center space-x-2 mb-1">
                        <span className="font-medium text-sys-text-primary">{type.label}</span>
                        <span
                          className={cn(
