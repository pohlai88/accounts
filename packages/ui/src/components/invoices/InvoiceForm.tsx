        ...
        <div className={cn('max-w-4xl mx-auto p-6 space-y-6', className)}>
            ...
            <div className="bg-sys-bg-raised border border-sys-border-hairline rounded-lg p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        <label htmlFor="customer-search" className="block text-sm font-medium text-sys-text-primary mb-2">
                            Customer
                        </label>
                    ...
                    <div>
                        <label htmlFor="invoice-number" className="block text-sm font-medium text-sys-text-primary mb-2">
                            Invoice Number
                        </label>
                        <input
                            id="invoice-number"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                    <div>
                        <label htmlFor="issue-date" className="block text-sm font-medium text-sys-text-primary mb-2">
                            Issue Date
                        </label>
                        <div className="relative">
                            <input
            ...
            {/* Notes */}
            <div className="bg-sys-bg-raised border border-sys-border-hairline rounded-lg p-6">
                <label htmlFor="invoice-notes" className="block text-sm font-medium text-sys-text-primary mb-2">
                    Notes
                </label>
                <textarea
                    id="invoice-notes"
