...
export const RuleTesting: React.FC<RuleTestingProps> = ({
    ...
    const filteredTestResults = useMemo(() => {
        return testResults.filter(result =>
            !selectedRuleId || result.ruleId === selectedRuleId
        );
    ...
    const testStats = useMemo(() => {
        ...
        const avgExecutionTime = total > 0
            ? filteredTestResults.reduce((sum, r) => sum + r.executionTime, 0) / total
            : 0;
                                ...
                                {testDataSets.map((dataSet) => (
                                    <div
                                        ...
                                        className={cn(
                                            ...
                                            selectedDataSetId === dataSet.id ? "bg-[var(--sys-fill-low)] border-[var(--sys-accent)]" : "hover:bg-[var(--sys-fill-low)]"
                                        )}
                                    ...
                                    >
                                        ...
                                        <p className="text-sm text-[var(--sys-text-secondary)] mb-2">{dataSet.description}</p>
                                        ...
                                        {recentTestResults.map((result) => (
                                            ...
                                            >
                                                ...
                                                <div className="grid grid-cols-3 gap-4 text-sm">
                                                    <div>
                                                        <span className="text-[var(--sys-text-secondary)]">Execution Time:</span>
                                                    ...
                                                    <div>
                                                        ...
                                                        <span className="ml-1 text-[var(--sys-text-primary)]">
                                                            {result.actions.filter(a => a.executed).length}/{result.actions.length}
                                                        </span>
                                                    </div>
                                                </div>
                                                        ...
                                                        {result.conditions.map((condition, index) => (
                                                            <div key={index} className="flex items-center space-x-2 text-sm">
                                                                <div className={cn(
                                                                    ...
                                                                    condition.result ? "bg-[var(--sys-status-success)]" : "bg-[var(--sys-status-error)]"
                                                                )} />
                                                                <span className="text-[var(--sys-text-secondary)]">{condition.condition}</span>
                                                    ...
                                                    <div className="space-y-1">
                                                        {result.actions.map((action, index) => (
                                                            <div key={index} className="flex items-center space-x-2 text-sm">
                                                                <div className={cn(
                                                                    "w-2 h-2 rounded-full",
                                                                    action.executed ? "bg-[var(--sys-status-success)]" : "bg-[var(--sys-text-tertiary)]"
                                                                )} />
                                                                <span className="text-[var(--sys-text-secondary)]">{action.action}</span>
                                                                {action.executed && (
                                                                    <span className="text-[var(--sys-text-primary)]">
