...
const OfflineManager = lazy(() => import('./OfflineManager').then(m => ({ default: m.OfflineManager })));
const ConflictResolver = lazy(() => import('./ConflictResolver').then(m => ({ default: m.ConflictResolver })));
const BackgroundSync = lazy(() => import('./BackgroundSync').then(m => ({ default: m.BackgroundSync })));
const MobileWorkflows = lazy(() => import('./MobileWorkflows').then(m => ({ default: m.MobileWorkflows })));
const ProgressiveWebApp = lazy(() => import('./ProgressiveWebApp').then(m => ({ default: m.ProgressiveWebApp })));
    ...
    return (
        <div className="flex flex-col md:flex-row h-full bg-[var(--sys-bg-surface)]">
            ...
            <Card className="w-full md:w-64 flex-shrink-0 border-r border-[var(--sys-border-hairline)] bg-[var(--sys-bg-primary)] p-4 md:p-6">
                <div className="mb-6">
                    <h2 className="text-xl font-semibold text-[var(--sys-text-primary)] mb-2">Mobile & Offline</h2>
                    <Input
                        type="text"
