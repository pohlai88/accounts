...
export const BackgroundSync: React.FC<BackgroundSyncProps> = ({
    ...
    const handleUpdateSettings = useCallback(async (newSettings: NotificationSettings) => {
    ...
    const getJobStatusColor = (status: string) => {
        switch (status) {
            ...
            case 'paused': return 'text-[var(--sys-status-warning)] bg-[var(--sys-status-warning)]/10';
            case 'pending': return 'text-[var(--sys-text-tertiary)] bg-[var(--sys-fill-low)]';
    ...
    const filteredJobs = selectedJobType === 'all'
        ? syncJobs
        : syncJobs.filter(job => job.type === selectedJobType);
                    ...
                    <div className="space-y-4">
                                    ...
                                    <div key={job.id} className="p-4 border border-[var(--sys-border-hairline)] rounded-lg hover:bg-[var(--sys-fill-low)] transition-colors">
                                        <div className="flex items-center justify-between">
                                            ...
                                            <div className="flex items-center space-x-2">
                                                <div className={cn("px-2 py-1 rounded-full text-xs font-medium", getJobStatusColor(job.status))}>
                        ...
                        {filteredJobs.length === 0 && (
                            <div className="text-center py-8">
                                ...
                                <h3 className="text-lg font-medium text-[var(--sys-text-primary)] mb-2">No Sync Jobs</h3>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="space-y-3">
                                <label className="flex items-center space-x-3">
                                    ...
                                    />
                                    <span className="text-sm text-[var(--sys-text-primary)]">Enable Notifications</span>
                                </label>
                            </div>
                        </div>
                            ...
                            <div className="space-y-3">
                                ...
                                {notificationSettings.quietHours.enabled && (
                                    <div className="grid grid-cols-2 gap-4">
                                        <div>
                                            <label className="block text-xs text-[var(--sys-text-secondary)] mb-1">Start Time</label>
                                            <input
                                                type="time"
                                        ...
                                        <div>
                                            <label className="block text-xs text-[var(--sys-text-secondary)] mb-1">End Time</label>
                                            <input
                                                type="time"
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="space-y-3">
                                <div className="flex items-center space-x-3">
                                    <CheckCircle className="h-4 w-4 text-[var(--sys-status-success)]" />
                                    <div>
                                        <p className="text-sm font-medium text-[var(--sys-text-primary)]">Automatic Sync</p>
                                        <p className="text-xs text-[var(--sys-text-secondary)]">Syncs data in the background when online</p>
                                    </div>
                                </div>
                                <div className="flex items-center space-x-3">
                                    <CheckCircle className="h-4 w-4 text-[var(--sys-status-success)]" />
                                    <div>
                                        <p className="text-sm font-medium text-[var(--sys-text-primary)]">Incremental Updates</p>
                                        <p className="text-xs text-[var(--sys-text-secondary)]">Only syncs changed data for efficiency</p>
                                    </div>
                                </div>
                                <div className="flex items-center space-x-3">
                                    <CheckCircle className="h-4 w-4 text-[var(--sys-status-success)]" />
                                    <div>
                                        <p className="text-sm font-medium text-[var(--sys-text-primary)]">Retry Logic</p>
                                        <p className="text-xs text-[var(--sys-text-secondary)]">Automatically retries failed operations</p>
                                    </div>
                                </div>
                                <div className="flex items-center space-x-3">
                                    <CheckCircle className="h-4 w-4 text-[var(--sys-status-success)]" />
                                    <div>
                                        ...
                                        <p className="text-xs text-[var(--sys-text-secondary)]">Handles data conflicts intelligently</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="space-y-3">
                                <div className="flex items-center space-x-3">
                                    <CheckCircle className="h-4 w-4 text-[var(--sys-status-success)]" />
                                    <div>
                                        <p className="text-sm font-medium text-[var(--sys-text-primary)]">Push Notifications</p>
                                        <p className="text-xs text-[var(--sys-text-secondary)]">Real-time updates on mobile devices</p>
                                    </div>
                                </div>
                                <div className="flex items-center space-x-3">
                                    <CheckCircle className="h-4 w-4 text-[var(--sys-status-success)]" />
                                    <div>
                                        <p className="text-sm font-medium text-[var(--sys-text-primary)]">Customizable Alerts</p>
                                        <p className="text-xs text-[var(--sys-text-secondary)]">Choose which events to be notified about</p>
                                    </div>
                                </div>
                                <div className="flex items-center space-x-3">
                                    <CheckCircle className="h-4 w-4 text-[var(--sys-status-success)]" />
                                    <div>
                                        <p className="text-sm font-medium text-[var(--sys-text-primary)]">Quiet Hours</p>
                                        <p className="text-xs text-[var(--sys-text-secondary)]">Silence notifications during specified times</p>
                                    </div>
                                </div>
                                <div className="flex items-center space-x-3">
                                    <CheckCircle className="h-4 w-4 text-[var(--sys-status-success)]" />
                                    <div>
                                        <p className="text-sm font-medium text-[var(--sys-text-primary)]">Rich Notifications</p>
                                        <p className="text-xs text-[var(--sys-text-secondary)]">Detailed information in notification content</p>
                                    </div>
                                </div>
                            </div>
                        </div>
