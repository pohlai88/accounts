...
export const OfflineManager: React.FC<OfflineManagerProps> = ({
    ...
    const getConnectionStatusColor = (quality: string) => {
        switch (quality) {
            case 'excellent': return 'text-[var(--sys-status-success)] bg-[var(--sys-status-success)]/10';
            case 'good': return 'text-[var(--sys-status-info)] bg-[var(--sys-status-info)]/10';
            case 'poor': return 'text-[var(--sys-status-warning)] bg-[var(--sys-status-warning)]/10';
            case 'offline': return 'text-[var(--sys-status-error)] bg-[var(--sys-status-error)]/10';
    ...
    const getOperationStatusColor = (status: string) => {
        switch (status) {
            ...
            case 'syncing': return 'text-[var(--sys-status-info)] bg-[var(--sys-status-info)]/10';
            case 'failed': return 'text-[var(--sys-status-error)] bg-[var(--sys-status-error)]/10';
            case 'pending': return 'text-[var(--sys-status-warning)] bg-[var(--sys-status-warning)]/10';
            default: return 'text-[var(--sys-text-tertiary)] bg-[var(--sys-fill-low)]';
        }
    };
                        ...
                        <div className="flex items-center space-x-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-[var(--sys-text-secondary)]">
                                    {formatTimeAgo(syncStatus.lastSync)} • {syncStatus.pendingOperations} operations pending
                                </p>
                            </div>
                        </div>
                    </CardContent>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="space-y-3">
                            {filteredOperations.map((operation) => {
                                ...
                                return (
                                    <div key={operation.id} className="p-4 border border-[var(--sys-border-hairline)] rounded-lg hover:bg-[var(--sys-fill-low)] transition-colors">
                                        <div className="flex items-center justify-between">
                                            <div className="flex items-center space-x-3">
                                            ...
                                            <div className="flex items-center space-x-2">
                                                <div className={cn("px-2 py-1 rounded-full text-xs font-medium", getOperationStatusColor(operation.status))}>
                        ...
                        {filteredOperations.length === 0 && (
                            <div className="text-center py-8">
                                ...
                                <h3 className="text-lg font-medium text-[var(--sys-text-primary)] mb-2">No Operations</h3>
                            ...
                            <div className="space-y-3">
                                <div className="flex items-center space-x-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-[var(--sys-text-secondary)]">Browse cached invoices, bills, and reports</p>
                                    </div>
                                </div>
                                <div className="flex items-center space-x-3">
                                    <CheckCircle className="h-4 w-4 text-[var(--sys-status-success)]" />
                                    <div>
                                        <p className="text-sm font-medium text-[var(--sys-text-primary)]">Create Records</p>
                                        <p className="text-xs text-[var(--sys-text-secondary)]">Draft invoices and bills offline</p>
                                    </div>
                                </div>
                                <div className="flex items-center space-x-3">
                                    <CheckCircle className="h-4 w-4 text-[var(--sys-status-success)]" />
                                    <div>
                                        <p className="text-sm font-medium text-[var(--sys-text-primary)]">Edit Records</p>
                                        <p className="text-xs text-[var(--sys-text-secondary)]">Modify existing records locally</p>
                                    </div>
                                </div>
                                <div className="flex items-center space-x-3">
                                    <CheckCircle className="h-4 w-4 text-[var(--sys-status-success)]" />
                                    <div>
                                        <p className="text-sm font-medium text-[var(--sys-text-primary)]">Generate Reports</p>
                                        <p className="text-xs text-[var(--sys-text-secondary)]">Create reports from cached data</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="space-y-3">
                                <div className="flex items-center space-x-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-[var(--sys-text-secondary)]">Automatic sync when connection restored</p>
                                    </div>
                                </div>
                                <div className="flex items-center space-x-3">
                                    <CheckCircle className="h-4 w-4 text-[var(--sys-status-success)]" />
                                ...
                                <div className="flex items-center space-x-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-[var(--sys-text-secondary)]">Exponential backoff for failed operations</p>
                                    </div>
                                </div>
                                <div className="flex items-center space-x-3">
                                    <CheckCircle className="h-4 w-4 text-[var(--sys-status-success)]" />
                                    <div>
                                        <p className="text-sm font-medium text-[var(--sys-text-primary)]">Data Integrity</p>
                                        <p className="text-xs text-[var(--sys-text-secondary)]">Ensures data consistency across devices</p>
                                    </div>
                                </div>
                            </div>
                        </div>
