      ...
      {testResults.length > 0 && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>Results from recent rule testing.</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-sys-fg-muted">{result.matches} matches found</p>
                      </div>
                    </div>
                    ...
                    <div className="mt-4 pt-4 border-t border-sys-border">
                      ...
                      <div className="space-y-2 mt-2">
                        {result.sampleMatches.map((match, index) => (
                          <div
                            key={index}
                            className="flex items-center gap-4 p-2 bg-sys-gray-50 rounded-md"
                          >
                            <div className="flex-1">
