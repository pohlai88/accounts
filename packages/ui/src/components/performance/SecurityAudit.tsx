      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Card className="p-4">
          <CardContent className="p-0">
            ...
            <div className="text-xs text-[var(--sys-text-tertiary)]">Immediate action required</div>
          </CardContent>
        </Card>
        ...
        <Card className="p-4">
          <CardContent className="p-0">
            ...
            <div className="text-xs text-[var(--sys-text-tertiary)]">Address within 7 days</div>
          </CardContent>
        </Card>
        ...
        <Card className="p-4">
          <CardContent className="p-0">
            ...
            <div className="text-xs text-[var(--sys-text-tertiary)]">Average across standards</div>
          </CardContent>
        </Card>
      </div>
            ...
            {compliance.map(item => (
              ...
              >
                ...
                <div className="flex items-center space-x-2">
                  <Badge variant="outline">{item.issues.length} issues</Badge>
