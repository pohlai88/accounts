...
const SecurityAudit = lazy(() => import('./SecurityAudit').then(m => ({ default: m.SecurityAudit })));
const DataEncryption = lazy(() => import('./DataEncryption').then(m => ({ default: m.DataEncryption })));
const BackupRecovery = lazy(() => import('./BackupRecovery').then(m => ({ default: m.BackupRecovery })));
const MonitoringAlerting = lazy(() => import('./MonitoringAlerting').then(m => ({ default: m.MonitoringAlerting })));
    ...
    return (
        <div className="flex flex-col md:flex-row h-full bg-[var(--sys-bg-surface)]">
            ...
            <Card className="w-full md:w-64 flex-shrink-0 border-r border-[var(--sys-border-hairline)] bg-[var(--sys-bg-primary)] p-4 md:p-6">
                <div className="mb-6">
                    <h2 className="text-xl font-semibold text-[var(--sys-text-primary)] mb-2">Performance & Security</h2>
                    <Input
                        type="text"
                        ...
                        return (
                            <Button
                                ...
                                className={cn(
                                    ...
                                    activeSection === section.id && "bg-[var(--sys-fill-low)] text-[var(--sys-text-primary)]"
                                )}
