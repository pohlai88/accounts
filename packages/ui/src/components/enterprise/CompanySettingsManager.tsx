  ...
  return (
    <div className={cn("space-y-6", className)}>
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-xl font-semibold text-[var(--sys-text-primary)]">Company Settings</h2>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <select
                      ...
                      onChange={e =>
                        handleSettingChange("financial.accountingMethod", e.target.value)
                      }
                      className="w-full px-3 py-2 border border-[var(--sys-border-hairline)] rounded-lg bg-[var(--sys-bg-primary)] text-[var(--sys-text-primary)] focus:outline-none focus:ring-2 focus:ring-[var(--sys-accent)] focus:border-transparent"
                    >
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={e =>
                        handleSettingChange("financial.inventoryMethod", e.target.value)
                      }
                      className="w-full px-3 py-2 border border-[var(--sys-border-hairline)] rounded-lg bg-[var(--sys-bg-primary)] text-[var(--sys-text-primary)] focus:outline-none focus:ring-2 focus:ring-[var(--sys-accent)] focus:border-transparent"
                    >
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-2">
                    <input
                      ...
                      onChange={e =>
                        handleSettingChange("financial.taxSettings.enabled", e.target.checked)
                      }
                      className="h-4 w-4 text-[var(--sys-accent)] border-[var(--sys-border-hairline)] rounded focus:ring-[var(--sys-accent)]"
                    />
                    <label
                      htmlFor="taxEnabled"
                      className="text-sm font-medium text-[var(--sys-text-primary)]"
                    >
                    ...
                    <>
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={e =>
                            handleSettingChange(
                              "financial.taxSettings.registrationNumber",
                              e.target.value,
                            )
                          }
                          className="w-full px-3 py-2 border border-[var(--sys-border-hairline)] rounded-lg bg-[var(--sys-bg-primary)] text-[var(--sys-text-primary)] focus:outline-none focus:ring-2 focus:ring-[var(--sys-accent)] focus:border-transparent"
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-2">
                    <input
                      ...
                      onChange={e =>
                        handleSettingChange("compliance.gdprEnabled", e.target.checked)
                      }
                      className="h-4 w-4 text-[var(--sys-accent)] border-[var(--sys-border-hairline)] rounded focus:ring-[var(--sys-accent)]"
                    />
                    <label
                  ...
                  <div className="flex items-center space-x-2">
                    <input
                      ...
                      onChange={e =>
                        handleSettingChange("compliance.soxCompliant", e.target.checked)
                      }
                      className="h-4 w-4 text-[var(--sys-accent)] border-[var(--sys-border-hairline)] rounded focus:ring-[var(--sys-accent)]"
                    />
                    <label
                      htmlFor="soxCompliant"
                      className="text-sm font-medium text-[var(--sys-text-primary)]"
                    >
                      SOX Compliance
                    </label>
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-2">
                    <input
                      ...
                      onChange={e =>
                        handleSettingChange("compliance.multiFactorAuth", e.target.checked)
                      }
                      className="h-4 w-4 text-[var(--sys-accent)] border-[var(--sys-border-hairline)] rounded focus:ring-[var(--sys-accent)]"
                    />
                    <label
                      htmlFor="multiFactorAuth"
                      className="text-sm font-medium text-[var(--sys-text-primary)]"
                    >
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={e =>
                        handleSettingChange("compliance.sessionTimeout", parseInt(e.target.value))
                      }
                      className="w-full px-3 py-2 border border-[var(--sys-border-hairline)] rounded-lg bg-[var(--sys-bg-primary)] text-[var(--sys-text-primary)] focus:outline-none focus:ring-2 focus:ring-[var(--sys-accent)] focus:border-transparent"
                    />
                  </div>
