...
export interface MultiCompanyManagerProps {
  ...
  onCompanyCreate: (
    companyData: Omit<Company, "id" | "createdAt" | "lastActivity" | "userCount">,
  ) => Promise<void>;
          ...
          >
            ...
            <div className="flex items-start justify-between mb-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h3 className="font-semibold text-[var(--sys-text-primary)]">{company.name}</h3>
                  <p className="text-sm text-[var(--sys-text-secondary)]">{company.industry}</p>
                </div>
              </div>
