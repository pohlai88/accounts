...
import {
    Users, Shield, Plus, Edit, Trash2, Search, Filter, MoreVertical,
    Check, X, AlertTriangle, Lock, Unlock, Eye, EyeOff, Settings
} from "lucide-react";
...
export interface UserRolesManagerProps {
    ...
    onRoleCreate: (roleData: Omit<Role, 'id' | 'createdAt' | 'updatedAt' | 'userCount'>) => Promise<void>;
