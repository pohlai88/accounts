...
import {
    Building2, Users, FileText, Settings, Shield, Globe, Bell, Lock,
    ChevronRight, Home, Search, Filter
} from "lucide-react";
                    ...
                    {sections.map((section) => {
                        ...
                        return (
                            ...
                            >
                                <div className={cn(
                                    "p-2 rounded-lg",
                                    isActive ? section.color : "text-[var(--sys-text-tertiary)] bg-[var(--sys-fill-low)]"
                                )}>
                                ...
                                <ChevronRight className={cn(
                                    ...
                                    isActive ? "text-[var(--sys-accent)] rotate-90" : "text-[var(--sys-text-tertiary)]"
                                )} />
                            </button>
                        );
                    })}
                ...
                <div className="flex-1 p-6 bg-[var(--sys-bg-secondary)] overflow-auto">
                    ...
                    {activeSection !== 'overview' && (
                        <div className="text-center py-12">
                            <div className={cn("w-16 h-16 mx-auto mb-4 rounded-lg flex items-center justify-center",
                                sections.find(s => s.id === activeSection)?.color || "bg-[var(--sys-fill-low)]"
                            )}>
                                {React.createElement(sections.find(s => s.id === activeSection)?.icon || Building2, {
                                    className: "h-8 w-8"
                                })}
                            </div>
                            ...
                            <p className="text-[var(--sys-text-secondary)] mb-6">
                                This section will contain the specific management interface for {sections.find(s => s.id === activeSection)?.name.toLowerCase()}.
                            </p>
