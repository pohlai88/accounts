...
export class ProductionDeployer {
    ...
    async deploy(): Promise<DeploymentResult> {
        ...
        try {
            ...
            steps.push(await this.runStep('Post-deployment Health Check', () => Promise.resolve(healthCheck)));
    ...
    private async runStep(name: string, stepFn: () => Promise<unknown>): Promise<DeploymentResult['steps'][0]> {
