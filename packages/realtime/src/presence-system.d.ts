...
export declare class PresenceSystem extends EventEmitter {
    ...
    private awayTimers;
    private config;
    constructor(wsManager: WebSocketManager, eventSystem: RealtimeEventSystem, config?: Partial<PresenceSystem['config']>);
    /**
     * Update user presence
     */
    updatePresence(userId: string, tenantId: string, status: PresenceInfo['status'], metadata?: PresenceInfo['metadata']): void;
    /**
     * Set user online
     */
     ...
     */
    subscribeToPresence(tenantId: string, callback: (update: PresenceUpdate) => void, options?: {
        userId?: string;
