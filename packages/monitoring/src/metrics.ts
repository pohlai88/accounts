...
export class MetricsCollector {
    ...
    private initializeCustomMetrics(): void {
        ...
        this.createHistogram('http_request_duration_seconds', 'HTTP request duration in seconds', ['method', 'route'], [0.1, 0.5, 1, 2, 5, 10]);

        // Cache metrics
        this.createCounter('cache_operations_total', 'Total number of cache operations', ['operation', 'result']);
        ...
        this.createCounter('invoices_processed_total', 'Total number of invoices processed', ['tenant_id', 'status']);
        this.createCounter('attachments_uploaded_total', 'Total number of attachments uploaded', ['tenant_id', 'type']);
    ...
    private createHistogram(name: string, help: string, labelNames: string[] = [], buckets: number[] = [0.1, 0.5, 1, 2, 5, 10]): Histogram {
    ...
    private createSummary(name: string, help: string, labelNames: string[] = [], percentiles: number[] = [0.5, 0.9, 0.95, 0.99]): Summary {
