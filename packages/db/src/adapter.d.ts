 ...
 */
export declare function queryTyped<T extends ZodTypeAny>(run: () => Promise<unknown[]>, schema: T): Promise<z.infer<T>[]>;
/**
 ...
 */
export declare function queryTypedSingle<T extends ZodTypeAny>(run: () => Promise<unknown>, schema: T): Promise<z.infer<T>>;
