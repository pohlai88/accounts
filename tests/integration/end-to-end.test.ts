...
import { createIdempotencyManager, defaultIdempotencyConfig, createIdempotencyMiddleware, createIdempotencyValidationMiddleware } from '../../packages/utils/src/idempotency';
...
describe('End-to-End Integration', () => {
    ...
    function setupTestRoutes() {
        ...
        gateway.route('/api/update/:id', 'PUT')
            .handler(async (req) => ({
                status: 200,
                headers: { 'Content-Type': 'application/json' },
                body: {
    ...
    describe('Idempotency Integration', () => {
        ...
        it('should reject invalid idempotency keys', async () => {
            ...
            // Register test route
            testGateway.route('/api/create', 'POST')
                .handler(async (req) => ({
                    status: 201,
                    headers: { 'Content-Type': 'application/json' },
    ...
    describe('Rate Limiting Integration', () => {
        it('should enforce rate limits', async () => {
            ...
            // Register test route
            testGateway.route('/api/rate-test', 'GET')
                .handler(async (req) => ({
                    status: 200,
                    headers: { 'Content-Type': 'application/json' },
    ...
    describe('Error Handling Integration', () => {
        it('should handle middleware errors gracefully', async () => {
            ...
            // Register test route
            testGateway.route('/api/test', 'GET')
                .handler(async (req) => ({
                    status: 200,
                    headers: { 'Content-Type': 'application/json' },
                    body: { message: 'Test successful' }
        ...
        it('should handle handler errors with proper error responses', async () => {
            ...
            testGateway.route('/api/error', 'GET')
                .handler(async (req) => {
