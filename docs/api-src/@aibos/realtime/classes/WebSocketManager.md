...
[AI-BOS Accounts API Documentation (Source)](../../../README.md) / [@aibos/realtime](../README.md) / [](../README.md) / WebSocketManager

# Class: WebSocketManager

Defined in: [packages/realtime/src/websocket-manager.ts:69](https://github.com/pohlai88/accounts/blob/48103fb36d28b2b9bfb33472b6de2f719773cde9/packages/realtime/src/websocket-manager.ts#L69)
...
Defined in: [packages/realtime/src/websocket-manager.ts:78](https://github.com/pohlai88/accounts/blob/48103fb36d28b2b9bfb33472b6de2f719773cde9/packages/realtime/src/websocket-manager.ts#L78)

#### Parameters

##### config

`Partial`\<[`WebSocketConfig`](../interfaces/WebSocketConfig.md)\> = `{}`
...
> **broadcastToChannel**(`channel`, `message`): `number`

Defined in: [packages/realtime/src/websocket-manager.ts:426](https://github.com/pohlai88/accounts/blob/48103fb36d28b2b9bfb33472b6de2f719773cde9/packages/realtime/src/websocket-manager.ts#L426)
...
`Omit`\<`WebSocketMessage`, `"tenantId"` \| `"userId"` \| `"timestamp"`\>
...
> **broadcastToTenant**(`tenantId`, `message`): `number`

Defined in: [packages/realtime/src/websocket-manager.ts:400](https://github.com/pohlai88/accounts/blob/48103fb36d28b2b9bfb33472b6de2f719773cde9/packages/realtime/src/websocket-manager.ts#L400)
...
> **getConnection**(`connectionId`): `undefined` \| [`ConnectionInfo`](../interfaces/ConnectionInfo.md)

Defined in: [packages/realtime/src/websocket-manager.ts:521](https://github.com/pohlai88/accounts/blob/48103fb36d28b2b9bfb33472b6de2f719773cde9/packages/realtime/src/websocket-manager.ts#L521)
...
`undefined` \| [`ConnectionInfo`](../interfaces/ConnectionInfo.md)
...
Defined in: [packages/realtime/src/websocket-manager.ts:550](https://github.com/pohlai88/accounts/blob/48103fb36d28b2b9bfb33472b6de2f719773cde9/packages/realtime/src/websocket-manager.ts#L550)
...
> **getStats**(): [`WebSocketStats`](../interfaces/WebSocketStats.md)

Defined in: [packages/realtime/src/websocket-manager.ts:540](https://github.com/pohlai88/accounts/blob/48103fb36d28b2b9bfb33472b6de2f719773cde9/packages/realtime/src/websocket-manager.ts#L540)

Get statistics

#### Returns

[`WebSocketStats`](../interfaces/WebSocketStats.md)

***

### getTenantConnections()

> **getTenantConnections**(`tenantId`): [`ConnectionInfo`](../interfaces/ConnectionInfo.md)[]

Defined in: [packages/realtime/src/websocket-manager.ts:528](https://github.com/pohlai88/accounts/blob/48103fb36d28b2b9bfb33472b6de2f719773cde9/packages/realtime/src/websocket-manager.ts#L528)
...
> **sendMessage**(`connectionId`, `message`): `boolean`

Defined in: [packages/realtime/src/websocket-manager.ts:380](https://github.com/pohlai88/accounts/blob/48103fb36d28b2b9bfb33472b6de2f719773cde9/packages/realtime/src/websocket-manager.ts#L380)
...
Defined in: [packages/realtime/src/websocket-manager.ts:108](https://github.com/pohlai88/accounts/blob/48103fb36d28b2b9bfb33472b6de2f719773cde9/packages/realtime/src/websocket-manager.ts#L108)
...
Defined in: [packages/realtime/src/websocket-manager.ts:147](https://github.com/pohlai88/accounts/blob/48103fb36d28b2b9bfb33472b6de2f719773cde9/packages/realtime/src/websocket-manager.ts#L147)
...
Defined in: [packages/realtime/src/websocket-manager.ts:576](https://github.com/pohlai88/accounts/blob/48103fb36d28b2b9bfb33472b6de2f719773cde9/packages/realtime/src/websocket-manager.ts#L576)
...
Defined in: [packages/realtime/src/websocket-manager.ts:583](https://github.com/pohlai88/accounts/blob/48103fb36d28b2b9bfb33472b6de2f719773cde9/packages/realtime/src/websocket-manager.ts#L583)
