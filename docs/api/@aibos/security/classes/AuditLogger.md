...
[AI-BOS Accounts API Documentation](../../../README.md) / [@aibos/security](../README.md) / [](../README.md) / AuditLogger
...
> `readonly` `static` **captureRejectionSymbol**: *typeof* [`captureRejectionSymbol`](AdvancedSecurityManager.md#capturerejectionsymbol)
...
> `readonly` `static` **errorMonitor**: *typeof* [`errorMonitor`](AdvancedSecurityManager.md#errormonitor)
...
set by `emitter.setMaxListeners(n)` or defaults to [EventEmitter.defaultMaxListeners](AdvancedSecurityManager.md#defaultmaxlisteners).
