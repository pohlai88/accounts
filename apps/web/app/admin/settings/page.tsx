  ...
  return (
    <div className="space-y-6">
      ...
      <div className="border-b border-[var(--sys-border-hairline)] pb-4">
        <h1 className="text-2xl font-bold text-[var(--sys-text-primary)]">System Configuration</h1>
      ...
      <form action={saveAdminSettings} className="space-y-8">
        ...
        <div className="bg-[var(--sys-bg-primary)] border border-[var(--sys-border-hairline)] rounded-lg p-6">
          ...
          <div className="space-y-6">
            ...
            <div>
              <label
                htmlFor="approval_threshold_rm"
                className="block text-sm font-medium text-[var(--sys-text-primary)] mb-2"
              >
              ...
              />
              <p
                id="approval_threshold_rm-description"
                className="mt-1 text-xs text-[var(--sys-text-secondary)]"
              >
            ...
            <div>
              ...
              />
              <p
                id="session_timeout_minutes-description"
                className="mt-1 text-xs text-[var(--sys-text-secondary)]"
              >
            ...
            <div className="flex items-center justify-between">
              <div>
                <label
                  htmlFor="export_requires_reason"
                  className="text-sm font-medium text-[var(--sys-text-primary)]"
                >
                  Export Requires Reason
                </label>
            ...
            <div className="flex items-center justify-between">
              <div>
                <label
                  htmlFor="mfa_required_for_admin"
                  className="text-sm font-medium text-[var(--sys-text-primary)]"
                >
                  MFA Required for Admin
                </label>
      ...
      <div className="bg-[var(--sys-bg-subtle)] border border-[var(--sys-border-hairline)] rounded-lg p-6">
        <h3 className="text-sm font-medium text-[var(--sys-text-primary)] mb-2">Need Help?</h3>
        <p className="text-xs text-[var(--sys-text-secondary)] mb-3">
          For assistance with system configuration, contact your system administrator or refer to
          the documentation.
        </p>
