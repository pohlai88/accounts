...
export async function GET(req: NextRequest) {
  try {
    ...
    logger.error("Get usage error", error instanceof Error ? error : new Error(String(error)));
...
export async function POST(req: NextRequest) {
  try {
    ...
    logger.error("Record usage error", error instanceof Error ? error : new Error(String(error)));
