...
// Invoices routes
gateway.route('/api/invoices', 'GET')
...
gateway.route('/api/invoices', 'POST')
    .middleware([authMiddleware])
    .handler(async (req) => {
...
// Customers routes
gateway.route('/api/customers', 'GET')
    .middleware([authMiddleware])
    .handler(async (req) => {
...
gateway.route('/api/customers', 'POST')
    .middleware([authMiddleware])
    .handler(async (req) => {
...
// Journals routes
gateway.route('/api/journals', 'GET')
    .middleware([authMiddleware])
    .handler(async (req) => {
...
gateway.route('/api/journals', 'POST')
    .middleware([authMiddleware])
    .handler(async (req) => {
...
// Accounts routes
gateway.route('/api/accounts', 'GET')
    .middleware([authMiddleware])
    .handler(async (req) => {
